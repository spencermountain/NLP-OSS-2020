...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 52, 4, 972);
    			attr_dev(div1, "class", "sub svelte-1kxjpgs");
    			add_location(div1, file, 53, 4, 1009);
    			attr_dev(div2, "class", "caption svelte-1kxjpgs");
    			add_location(div2, file, 51, 2, 946);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file, 56, 0, 1053);
    		},
    ...
    const file$1 = "src/05.focus/Quake.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 9, 0, 188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
