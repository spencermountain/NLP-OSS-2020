...
var app = (function () {
    ...
    const file = "src/01.keyboards/ZoeSmith.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			add_location(img0, file, 28, 6, 472);
    			...
    			attr_dev(img1, "alt", "");
    			add_location(img1, file, 32, 6, 585);
    			attr_dev(div0, "class", "row svelte-1r29gou");
    			add_location(div0, file, 27, 4, 448);
    			attr_dev(div1, "class", "col svelte-1r29gou");
    			add_location(div1, file, 26, 2, 426);
    			attr_dev(div2, "class", "f1 mt1");
    			add_location(div2, file, 40, 4, 746);
    			attr_dev(div3, "class", "f2");
    			add_location(div3, file, 38, 2, 711);
    			attr_dev(div4, "class", "box");
    			add_location(div4, file, 25, 0, 406);
    			add_location(li, file, 45, 2, 835);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file, 44, 0, 813);
    		},
