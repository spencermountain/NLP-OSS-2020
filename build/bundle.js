...
var app = (function () {
    ...
    const file = "src/03.word-wrap/SpreadsheetSelect.svelte";
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 60, 6, 1276);
    		},
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 75, 10, 1775);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*i*/ ctx[6] === 4 && /*i2*/ ctx[9] === 14 && /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]] === "e") return create_if_block_1;
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(div, "class", "cell svelte-10qh3b4");
    			add_location(div, file, 72, 12, 1692);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 68, 12, 1561);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 64, 6, 1375);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 58, 4, 1207);
    			attr_dev(div1, "class", "container svelte-10qh3b4");
    			add_location(div1, file, 56, 2, 1158);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file, 55, 0, 1138);
    			add_location(li, file, 83, 2, 1875);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file, 82, 0, 1853);
    		},
