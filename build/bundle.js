...
var app = (function () {
    ...
    const file$2 = "Users/spencer/mountain/somehow-timeline/src/shapes/Line.svelte";
    ...
    */
    ...
    const file$3 = "Users/spencer/mountain/somehow-timeline/src/shapes/Label.svelte";
    ...
    const file$5 = "src/Components/TextArea.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$5, 41, 0, 923);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class TextArea extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { value: 0, width: 1, height: 2, size: 3 });
    ...
    const file$6 = "src/03.refactoring/Timeline.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 33, 2, 786);
    			attr_dev(div1, "class", "box ");
    			add_location(div1, file$6, 32, 0, 765);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
When a couple of guys, who were up to no good, started making trouble in my neighborhood.`;
    ...
    function create_fragment$7(ctx) {
    	...
    	let mounted;
    	let dispose;
    	cmp = new Timeline_1({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(cmp.$$.fragment);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(cmp, target, anchor);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(window, "keydown", /*nextPage*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(cmp.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(cmp.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(cmp, detaching);
    			mounted = false;
    			dispose();
    		}
    	};
