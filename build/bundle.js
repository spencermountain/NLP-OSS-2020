...
var app = (function () {
    ...
    function create_fragment$X(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (switch_instance) create_component(switch_instance.$$.fragment);
    			switch_instance_anchor = empty();
    			add_location(div0, file$P, 47, 0, 969);
    			option0.__value = "0";
    			option0.value = option0.__value;
    			add_location(option0, file$P, 50, 4, 1080);
    			option1.__value = "1";
    			option1.value = option1.__value;
    			add_location(option1, file$P, 51, 4, 1117);
    			option2.__value = "2";
    			option2.value = option2.__value;
    			add_location(option2, file$P, 52, 4, 1158);
    			option3.__value = "3";
    			option3.value = option3.__value;
    			add_location(option3, file$P, 53, 4, 1201);
    			option4.__value = "4";
    			option4.value = option4.__value;
    			add_location(option4, file$P, 54, 4, 1239);
    			option5.__value = "5";
    			option5.value = option5.__value;
    			add_location(option5, file$P, 55, 4, 1279);
    			option6.__value = "6";
    			option6.value = option6.__value;
    			add_location(option6, file$P, 56, 4, 1322);
    			if (/*i*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[6].call(select));
    			add_location(select, file$P, 49, 2, 998);
    			add_location(div1, file$P, 48, 0, 990);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$X($$self, $$props, $$invalidate) {
    	...
    	let i = 3;
    	let steps = [_00_intro, _01_keyboards, _01_punctuation, _02_markup, _03_word_wrap, _04_text_editor, _05_focus];
    	let doEnd = false;
