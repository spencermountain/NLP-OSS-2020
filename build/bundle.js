...
var app = (function () {
    ...
    var replace = function replace(newPhrase, doc) {
      ...
      append$1(this, newPhrase, doc); //delete original terms
    ...
    */
    ...
    var text$1$1 = function text(options) {
      var _this = this;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file, 45, 0, 1010);
    		},
    ...
    /* src/demos/Demo.svelte generated by Svelte v3.24.1 */
    const file$1 = "src/demos/Demo.svelte";
    ...
    function create_else_block(ctx) {
    	let span;
    	let t_value = /*o*/ ctx[4].text + (/*o*/ ctx[4].post.trim() || "") + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "word svelte-17wv48c");
    			add_location(span, file$1, 68, 10, 1491);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 2 && t_value !== (t_value = /*o*/ ctx[4].text + (/*o*/ ctx[4].post.trim() || "") + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    // (66:8) {#if o.tags.includes('dirty')}
    function create_if_block(ctx) {
    	let span;
    	let t_value = /*o*/ ctx[4].text + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "word back svelte-17wv48c");
    			add_location(span, file$1, 66, 10, 1425);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 2 && t_value !== (t_value = /*o*/ ctx[4].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(span);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(66:8) {#if o.tags.includes('dirty')}",
    		ctx
    	});
    ...
    // (65:6) {#each result as o}
    function create_each_block(ctx) {
    	let show_if;
    	let if_block_anchor;

    	function select_block_type(ctx, dirty) {
    		if (show_if == null || dirty & /*result*/ 2) show_if = !!/*o*/ ctx[4].tags.includes("dirty");
    ...
    function create_fragment$1(ctx) {
    	...
    	function textarea_value_binding(value) {
    		/*textarea_value_binding*/ ctx[3].call(null, value);
    	}
    	...
    	if (/*txt*/ ctx[0] !== void 0) {
    		textarea_props.value = /*txt*/ ctx[0];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			li = element("li");
    			attr_dev(div0, "class", "result svelte-17wv48c");
    			add_location(div0, file$1, 63, 4, 1329);
    			attr_dev(div1, "class", "middle svelte-17wv48c");
    			add_location(div1, file$1, 55, 2, 1122);
    			attr_dev(div2, "class", "box ");
    			add_location(div2, file$1, 54, 0, 1101);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$1, 76, 0, 1607);
    			add_location(li, file$1, 77, 0, 1629);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*txt*/ 1) {
    				updating_value = true;
    				textarea_changes.value = /*txt*/ ctx[0];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ nlp: src, TextArea, txt, result, change });
    	...
    	return [txt, result, change, textarea_value_binding];
    }
