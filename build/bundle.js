...
var app = (function () {
    ...
    const file$1 = "src/01.02.typing/Keyboard.1.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$1, 62, 2, 2137);
    			add_location(li1, file$1, 63, 2, 2212);
    			add_location(li2, file$1, 64, 2, 2245);
    			add_location(li3, file$1, 65, 2, 2298);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$1, 61, 0, 2115);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
