    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "word svelte-a6i0ko");
    			add_location(span, file$1, 71, 10, 1594);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "word back svelte-a6i0ko");
    			add_location(span, file$1, 69, 10, 1528);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(69:8) {#if o.tags.includes('dirty')}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			li = element("li");
    			attr_dev(div0, "class", "result svelte-a6i0ko");
    			add_location(div0, file$1, 66, 4, 1432);
    			attr_dev(div1, "class", "middle svelte-a6i0ko");
    			add_location(div1, file$1, 58, 2, 1225);
    			attr_dev(div2, "class", "box ");
    			add_location(div2, file$1, 57, 0, 1204);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$1, 79, 0, 1710);
    			add_location(li, file$1, 80, 0, 1732);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
