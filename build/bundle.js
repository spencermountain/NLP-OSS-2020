...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.00.keyboards/assets/wolfram-desk.jpg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file, 47, 8, 1045);
    			attr_dev(div0, "class", "square svelte-14wyv4x");
    			add_location(div0, file, 46, 6, 1016);
    			set_style(img1, "height", "320px");
    			if (img1.src !== (img1_src_value = "./src/01.punctuation/assets/injection.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file, 53, 8, 1211);
    			attr_dev(div1, "class", "square svelte-14wyv4x");
    			add_location(div1, file, 52, 6, 1182);
    			attr_dev(div2, "class", "row svelte-14wyv4x");
    			add_location(div2, file, 45, 4, 992);
    			set_style(img2, "width", "450px");
    			if (img2.src !== (img2_src_value = "./src/00.intro/assets/splash.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file, 62, 8, 1408);
    			attr_dev(div3, "class", "square svelte-14wyv4x");
    			add_location(div3, file, 61, 6, 1379);
    			attr_dev(span, "class", "blue ");
    			add_location(span, file, 71, 10, 1632);
    			attr_dev(div4, "class", "f1");
    			add_location(div4, file, 69, 8, 1582);
    			attr_dev(div5, "class", "square f4 svelte-14wyv4x");
    			add_location(div5, file, 67, 6, 1532);
    			attr_dev(div6, "class", "row svelte-14wyv4x");
    			add_location(div6, file, 60, 4, 1355);
    			attr_dev(div7, "class", "container svelte-14wyv4x");
    			add_location(div7, file, 44, 2, 964);
    			attr_dev(div8, "class", "box");
    			add_location(div8, file, 43, 0, 944);
    			attr_dev(div9, "class", "notes");
    			add_location(div9, file, 77, 0, 1731);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ done, doEnd, prev, fullScreen });
    ...
    const file$3 = "src/Components/Video.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*sub*/ ctx[2]);
    			attr_dev(div0, "class", "title svelte-gke2c");
    			add_location(div0, file$3, 45, 4, 812);
    			attr_dev(div1, "class", "sub svelte-gke2c");
    			add_location(div1, file$3, 46, 4, 849);
    			attr_dev(div2, "class", "caption svelte-gke2c");
    			add_location(div2, file$3, 44, 2, 786);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(track, file$3, 51, 4, 971);
    			attr_dev(video, "class", "vid svelte-gke2c");
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = /*loop*/ ctx[3];
    			video.autoplay = true;
    			video.muted = /*mute*/ ctx[4];
    			add_location(video, file$3, 50, 2, 912);
    			attr_dev(div, "class", "m3");
    			add_location(div, file$3, 49, 0, 893);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*mute*/ 16) {
    				prop_dev(video, "muted", /*mute*/ ctx[4]);
    			}
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { mute = true } = $$props;
    	const writable_props = ["src", "title", "sub", "loop", "mute"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("mute" in $$props) $$invalidate(4, mute = $$props.mute);
    	};

    	$$self.$capture_state = () => ({ src, title, sub, loop, mute });
    	...
    	return [src, title, sub, loop, mute];
    }
    ...
    /* src/00.intro/PastTenseDemo.svelte generated by Svelte v3.24.1 */
    const file$4 = "src/00.intro/PastTenseDemo.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			track = element("track");
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$4, 9, 6, 287);
    			set_style(video, "width", "700px");
    			attr_dev(video, "class", "vid");
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = true;
    			add_location(video, file$4, 8, 4, 207);
    			attr_dev(div0, "class", "size");
    			add_location(div0, file$4, 7, 2, 184);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$4, 6, 0, 164);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let src = "./src/00.intro/assets/pasttense-demo.mp4";
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PastTenseDemo> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("PastTenseDemo", $$slots, []);
    	$$self.$capture_state = () => ({ Video, wait, src });
    ...
    class PastTenseDemo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$5 = "src/00.intro/Compromise-history.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li1, file$5, 29, 2, 516);
    			attr_dev(div2, "class", "notes");
    ...
    const file$6 = "src/00.intro/Compromise-size.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$6, 25, 2, 458);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$6, 24, 0, 436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/00.intro/Compromise-latency.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$7, 21, 4, 345);
    			attr_dev(div0, "class", "row svelte-1oc9eez");
    			add_location(div0, file$7, 20, 2, 323);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$7, 19, 0, 303);
    			add_location(li0, file$7, 28, 2, 479);
    			add_location(li1, file$7, 29, 2, 521);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$7, 27, 0, 457);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/00.intro/Compromise-accuracy.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$8, 21, 4, 345);
    			attr_dev(div0, "class", "row svelte-1oc9eez");
    			add_location(div0, file$8, 20, 2, 323);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$8, 19, 0, 303);
    			add_location(li, file$8, 28, 2, 480);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$8, 27, 0, 458);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$9 = "src/00.intro/Resolution-1.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "todo svelte-duqrwi");
    			add_location(div0, file$9, 22, 4, 378);
    			attr_dev(div1, "class", "todo svelte-duqrwi");
    			add_location(div1, file$9, 23, 4, 425);
    			attr_dev(div2, "class", "todo svelte-duqrwi");
    			add_location(div2, file$9, 24, 4, 485);
    			attr_dev(div3, "class", "todo svelte-duqrwi");
    			add_location(div3, file$9, 25, 4, 552);
    			attr_dev(div4, "class", "todo svelte-duqrwi");
    			add_location(div4, file$9, 26, 4, 612);
    			attr_dev(div5, "class", "todo svelte-duqrwi");
    			add_location(div5, file$9, 27, 4, 660);
    			attr_dev(div6, "class", "main svelte-duqrwi");
    			add_location(div6, file$9, 21, 2, 355);
    			attr_dev(div7, "class", "box ");
    			add_location(div7, file$9, 20, 0, 334);
    			add_location(li, file$9, 32, 2, 747);
    			attr_dev(div8, "class", "notes");
    			add_location(div8, file$9, 31, 0, 725);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src/00.intro/Resolution-2.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "todo nope svelte-sxsojm");
    			add_location(div0, file$a, 28, 4, 492);
    			attr_dev(div1, "class", "todo nope svelte-sxsojm");
    			add_location(div1, file$a, 29, 4, 544);
    			attr_dev(div2, "class", "todo nope svelte-sxsojm");
    			add_location(div2, file$a, 30, 4, 609);
    			attr_dev(div3, "class", "todo svelte-sxsojm");
    			add_location(div3, file$a, 31, 4, 681);
    			attr_dev(div4, "class", "todo nope svelte-sxsojm");
    			add_location(div4, file$a, 32, 4, 741);
    			attr_dev(div5, "class", "todo nope svelte-sxsojm");
    			add_location(div5, file$a, 33, 4, 794);
    			attr_dev(div6, "class", "main svelte-sxsojm");
    			add_location(div6, file$a, 27, 2, 469);
    			attr_dev(div7, "class", "box");
    			add_location(div7, file$a, 26, 0, 449);
    			add_location(li, file$a, 38, 2, 886);
    			attr_dev(div8, "class", "notes");
    			add_location(div8, file$a, 37, 0, 864);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$b = "src/00.intro/Concept.1.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 24, 0, 497);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/00.intro/Concept.2.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$c, 20, 0, 390);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src/00.intro/Concept.3.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$d, 14, 0, 242);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src/00.intro/Shoulders.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$e, 28, 4, 470);
    			attr_dev(div0, "class", "background svelte-4kxeno");
    			add_location(div0, file$e, 27, 2, 441);
    			attr_dev(div1, "class", "mid svelte-4kxeno");
    			add_location(div1, file$e, 30, 2, 545);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$e, 26, 0, 421);
    			add_location(li0, file$e, 36, 2, 629);
    			add_location(li1, file$e, 37, 2, 664);
    			add_location(li2, file$e, 38, 2, 720);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$e, 35, 0, 607);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$f = "src/00.intro/Bear.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$f, 9, 0, 180);
    			add_location(li0, file$f, 13, 2, 250);
    			add_location(li1, file$f, 14, 2, 285);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$f, 12, 0, 228);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$g = "src/00.intro/FigureSkating.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$g, 14, 2, 231);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$g, 13, 0, 211);
    			add_location(li0, file$g, 19, 2, 311);
    			add_location(li1, file$g, 20, 2, 342);
    			add_location(li2, file$g, 21, 2, 396);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$g, 18, 0, 289);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$h = "src/00.intro/Question.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$h, 23, 4, 296);
    			attr_dev(span, "class", "red i");
    			add_location(span, file$h, 26, 6, 371);
    			attr_dev(div1, "class", "med svelte-10y1wyx");
    			add_location(div1, file$h, 24, 4, 330);
    			attr_dev(div2, "class", "blue med goright svelte-10y1wyx");
    			add_location(div2, file$h, 28, 4, 425);
    			add_location(div3, file$h, 22, 2, 286);
    			attr_dev(div4, "class", "box big svelte-10y1wyx");
    			add_location(div4, file$h, 21, 0, 262);
    			add_location(li, file$h, 32, 2, 512);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$h, 31, 0, 490);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$i = "src/00.intro/Menu.svelte";
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			span4 = element("span");
    			span4.textContent = "Markup languages";
    			t11 = space();
    			div4 = element("div");
    			span5 = element("span");
    			span5.textContent = "↓";
    			t13 = space();
    			span6 = element("span");
    			span6.textContent = "Data structures";
    			t15 = space();
    			div5 = element("div");
    			span7 = element("span");
    			span7.textContent = "↓";
    			t17 = space();
    			span8 = element("span");
    			span8.textContent = "NLP interface";
    			t19 = space();
    			div10 = element("div");
    			li0 = element("li");
    			li0.textContent = "1 - actual act of typing";
    			t21 = space();
    			li1 = element("li");
    			li1.textContent = "2 - punctuation and markup";
    			t23 = space();
    			li2 = element("li");
    			li2.textContent = "3 - word-wrap & datastructures";
    			t25 = space();
    			li3 = element("li");
    			li3.textContent = "4 - refactoring sentences, keyboard focus";
    			if (img.src !== (img_src_value = "./src/00.intro/assets/cn-tower-jump.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$i, 30, 6, 533);
    			set_style(div0, "width", "450px");
    			add_location(div0, file$i, 29, 4, 500);
    			attr_dev(span0, "class", "num red svelte-1spno7j");
    			add_location(span0, file$i, 35, 10, 699);
    			attr_dev(div1, "class", "f2 svelte-1spno7j");
    			add_location(div1, file$i, 34, 8, 672);
    			attr_dev(span1, "class", "num pink svelte-1spno7j");
    			add_location(span1, file$i, 39, 10, 800);
    			set_style(span2, "color", "#AB5850");
    			add_location(span2, file$i, 40, 10, 842);
    			attr_dev(div2, "class", "f2 svelte-1spno7j");
    			add_location(div2, file$i, 38, 8, 773);
    			attr_dev(span3, "class", "num blue svelte-1spno7j");
    			add_location(span3, file$i, 43, 10, 940);
    			set_style(span4, "color", "#6699cc");
    			add_location(span4, file$i, 44, 10, 982);
    			attr_dev(div3, "class", "f2 svelte-1spno7j");
    			add_location(div3, file$i, 42, 8, 913);
    			attr_dev(span5, "class", "num rose svelte-1spno7j");
    			add_location(span5, file$i, 47, 10, 1085);
    			set_style(span6, "color", "#8BA3A2");
    			add_location(span6, file$i, 48, 10, 1127);
    			attr_dev(div4, "class", "f2 svelte-1spno7j");
    			add_location(div4, file$i, 46, 8, 1058);
    			attr_dev(span7, "class", "num svelte-1spno7j");
    			add_location(span7, file$i, 51, 10, 1235);
    			set_style(span8, "color", "#d8b3e6");
    			add_location(span8, file$i, 52, 10, 1272);
    			attr_dev(div5, "class", "f2 rouge svelte-1spno7j");
    			add_location(div5, file$i, 50, 8, 1202);
    			set_style(div6, "text-align", "left");
    			attr_dev(div6, "class", "ml3");
    			add_location(div6, file$i, 33, 6, 621);
    			add_location(div7, file$i, 32, 4, 609);
    			attr_dev(div8, "class", "row svelte-1spno7j");
    			add_location(div8, file$i, 28, 2, 478);
    			attr_dev(div9, "class", "box");
    			add_location(div9, file$i, 27, 0, 458);
    			add_location(li0, file$i, 59, 2, 1399);
    			add_location(li1, file$i, 60, 2, 1435);
    			add_location(li2, file$i, 61, 2, 1473);
    			add_location(li3, file$i, 62, 2, 1515);
    			attr_dev(div10, "class", "notes");
    			add_location(div10, file$i, 58, 0, 1377);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$j = "src/00.intro/2020.svelte";
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "red i");
    			add_location(span, file$j, 25, 6, 329);
    			attr_dev(div0, "class", "med svelte-10y1wyx");
    			add_location(div0, file$j, 23, 4, 296);
    			add_location(div1, file$j, 22, 2, 286);
    			attr_dev(div2, "class", "box big svelte-10y1wyx");
    			add_location(div2, file$j, 21, 0, 262);
    			add_location(li, file$j, 30, 2, 410);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$j, 29, 0, 388);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class _00_intro extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$k, create_fragment$k, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    /* src/01.00.keyboards/OscarsTalk.svelte generated by Svelte v3.24.1 */
    const file$k = "src/01.00.keyboards/OscarsTalk.svelte";
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$k, 15, 0, 279);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/Mjackson.svelte generated by Svelte v3.24.1 */
    const file$l = "src/01.00.keyboards/Mjackson.svelte";
    ...
    function create_fragment$m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li.textContent = "2019";
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$l, 7, 0, 142);
    			add_location(li, file$l, 11, 2, 212);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$l, 10, 0, 190);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/Desks.svelte generated by Svelte v3.24.1 */

    const file$m = "src/01.00.keyboards/Desks.svelte";
    ...
    function create_fragment$n(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.00.keyboards/assets/desks/one.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$m, 10, 4, 82);
    			if (img1.src !== (img1_src_value = "./src/01.00.keyboards/assets/desks/two.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$m, 11, 4, 150);
    			if (img2.src !== (img2_src_value = "./src/01.00.keyboards/assets/desks/three.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$m, 12, 4, 218);
    			attr_dev(div0, "class", "row");
    			add_location(div0, file$m, 9, 2, 60);
    			if (img3.src !== (img3_src_value = "./src/01.00.keyboards/assets/desks/four.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			add_location(img3, file$m, 15, 4, 317);
    			if (img4.src !== (img4_src_value = "./src/01.00.keyboards/assets/desks/five.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "");
    			add_location(img4, file$m, 16, 4, 386);
    			if (img5.src !== (img5_src_value = "./src/01.00.keyboards/assets/desks/six.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "");
    			add_location(img5, file$m, 17, 4, 455);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$m, 14, 2, 295);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$m, 8, 0, 40);
    			add_location(li0, file$m, 22, 2, 558);
    			add_location(li1, file$m, 23, 2, 595);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$m, 21, 0, 536);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/ISSKeyboard.svelte generated by Svelte v3.24.1 */
    const file$n = "src/01.00.keyboards/ISSKeyboard.svelte";
    ...
    function create_fragment$o(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$n, 14, 0, 231);
    			add_location(li0, file$n, 19, 2, 302);
    			add_location(li1, file$n, 20, 2, 329);
    			add_location(li2, file$n, 21, 2, 355);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$n, 18, 0, 280);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/TonyAbra.svelte generated by Svelte v3.24.1 */

    const file$o = "src/01.00.keyboards/TonyAbra.svelte";
    ...
    function create_fragment$p(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.00.keyboards/assets/tony-1.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$o, 28, 6, 472);
    			set_style(img1, "height", "350px");
    			if (img1.src !== (img1_src_value = "./src/01.00.keyboards/assets/tony-3.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			...
    			add_location(div2, file$o, 40, 4, 752);
    			attr_dev(div3, "class", "f2");
    			add_location(div3, file$o, 38, 2, 714);
    			attr_dev(div4, "class", "box");
    			add_location(div4, file$o, 25, 0, 406);
    			add_location(li, file$o, 45, 2, 850);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$o, 44, 0, 828);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/ZoeSmith.svelte generated by Svelte v3.24.1 */

    const file$p = "src/01.00.keyboards/ZoeSmith.svelte";
    ...
    function create_fragment$q(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.00.keyboards/assets/zoe-smith.jpg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$p, 28, 6, 472);
    			set_style(img1, "height", "450px");
    			if (img1.src !== (img1_src_value = "./src/01.00.keyboards/assets/zoe-2.jpeg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$p, 32, 6, 588);
    			attr_dev(div0, "class", "row svelte-1r29gou");
    			add_location(div0, file$p, 27, 4, 448);
    			attr_dev(div1, "class", "col svelte-1r29gou");
    			add_location(div1, file$p, 26, 2, 426);
    			attr_dev(div2, "class", "f1 mt1");
    			add_location(div2, file$p, 40, 4, 752);
    			attr_dev(div3, "class", "f2");
    			add_location(div3, file$p, 38, 2, 717);
    			attr_dev(div4, "class", "box");
    			add_location(div4, file$p, 25, 0, 406);
    			add_location(li, file$p, 45, 2, 841);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$p, 44, 0, 819);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/HandKeyboards.svelte generated by Svelte v3.24.1 */

    const file$q = "src/01.00.keyboards/HandKeyboards.svelte";
    ...
    function create_fragment$r(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$q, 34, 8, 636);
    			set_style(video, "margin-bottom", "0px");
    			if (video.src !== (video_src_value = "./src/01.00.keyboards/assets/hand-computer.mp4")) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = true;
    			add_location(video, file$q, 28, 6, 472);
    			set_style(img, "height", "300px");
    			if (img.src !== (img_src_value = "./src/01.00.keyboards/assets/septambic.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$q, 36, 6, 683);
    			attr_dev(div0, "class", "row svelte-1r29gou");
    			add_location(div0, file$q, 27, 4, 448);
    			attr_dev(div1, "class", "col svelte-1r29gou");
    			add_location(div1, file$q, 26, 2, 426);
    			attr_dev(div2, "class", "f1 mt1");
    			add_location(div2, file$q, 44, 4, 851);
    			attr_dev(div3, "class", "f2");
    			add_location(div3, file$q, 42, 2, 815);
    			attr_dev(div4, "class", "box");
    			add_location(div4, file$q, 25, 0, 406);
    			add_location(li0, file$q, 49, 2, 934);
    			add_location(li1, file$q, 50, 2, 967);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$q, 48, 0, 912);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/Wolfram.svelte generated by Svelte v3.24.1 */

    const file$r = "src/01.00.keyboards/Wolfram.svelte";
    ...
    function create_fragment$s(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "./src/01.00.keyboards/assets/wolfram-desk.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "width", "500px;");
    			add_location(img, file$r, 19, 6, 309);
    			attr_dev(div0, "class", "");
    			add_location(div0, file$r, 18, 4, 288);
    			add_location(br0, file$r, 26, 6, 524);
    			add_location(br1, file$r, 28, 6, 569);
    			add_location(br2, file$r, 30, 6, 602);
    			add_location(br3, file$r, 32, 6, 645);
    			set_style(div1, "width", "300px");
    			set_style(div1, "font-size", "1.4rem");
    			attr_dev(div1, "class", "");
    			add_location(div1, file$r, 24, 4, 430);
    			attr_dev(div2, "class", "row svelte-ssqihk");
    			add_location(div2, file$r, 17, 2, 266);
    			attr_dev(div3, "class", "box");
    			add_location(div3, file$r, 16, 0, 246);
    			add_location(li0, file$r, 38, 2, 736);
    			add_location(li1, file$r, 39, 2, 755);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$r, 37, 0, 714);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.00.keyboards/index.svelte generated by Svelte v3.24.1 */
    ...
    function instance$t($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<_01_00_keyboards> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("_01_00_keyboards", $$slots, []);
    ...
    class _01_00_keyboards extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get done() {
    		throw new Error("<_01_00_keyboards>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set done(value) {
    		throw new Error("<_01_00_keyboards>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/01.02.typing/LoveTyping.svelte generated by Svelte v3.24.1 */
    const file$s = "src/01.02.typing/LoveTyping.svelte";
    ...
    function create_fragment$u(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$s, 7, 0, 142);
    			add_location(li0, file$s, 12, 2, 213);
    			add_location(li1, file$s, 13, 2, 246);
    			add_location(li2, file$s, 14, 2, 276);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$s, 11, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$u($$self, $$props, $$invalidate) {
    	let image = {
    		src: "./src/01.02.typing/assets/kids-typing.jpg"
    	};
    ...
    /* src/01.02.typing/NowCLI.svelte generated by Svelte v3.24.1 */
    const file$t = "src/01.02.typing/NowCLI.svelte";
    ...
    function create_fragment$v(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$t, 14, 0, 250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$v($$self, $$props, $$invalidate) {
    	let video = {
    		src: "./src/01.02.typing/assets/now-cli.mp4",
    		title: "Now CLI",
    ...
    /* src/01.02.typing/Typewriter.svelte generated by Svelte v3.24.1 */
    const file$u = "src/01.02.typing/Typewriter.svelte";
    ...
    function create_fragment$w(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$u, 9, 2, 193);
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$u, 7, 0, 141);
    			add_location(li0, file$u, 13, 2, 254);
    			add_location(li1, file$u, 14, 2, 298);
    			add_location(li2, file$u, 15, 2, 371);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$u, 12, 0, 232);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$w($$self, $$props, $$invalidate) {
    	let image = {
    		src: "./src/01.02.typing/assets/typewriter.jpg"
    	};
    ...
    /* src/01.02.typing/TypewriterMag.svelte generated by Svelte v3.24.1 */

    const file$v = "src/01.02.typing/TypewriterMag.svelte";
    ...
    function create_fragment$x(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "./src/01.02.typing/assets/mag-type.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "width", "450px;");
    			add_location(img, file$v, 19, 6, 309);
    			attr_dev(div0, "class", "");
    			add_location(div0, file$v, 18, 4, 288);
    			set_style(div1, "width", "300px");
    			set_style(div1, "font-size", "1.4rem");
    			attr_dev(div1, "class", "");
    			add_location(div1, file$v, 21, 4, 399);
    			attr_dev(div2, "class", "row svelte-ssqihk");
    			add_location(div2, file$v, 17, 2, 266);
    			attr_dev(div3, "class", "box");
    			add_location(div3, file$v, 16, 0, 246);
    			add_location(li0, file$v, 27, 2, 555);
    			add_location(li1, file$v, 28, 2, 594);
    			add_location(li2, file$v, 29, 2, 630);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$v, 26, 0, 533);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.02.typing/Insert.svelte generated by Svelte v3.24.1 */
    const file$w = "src/01.02.typing/Insert.svelte";
    ...
    function create_fragment$y(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$w, 21, 0, 324);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$y($$self, $$props, $$invalidate) {
    	let images = [
    		{
    			src: "./src/01.02.typing/assets/insert-1.png"
    		},
    		{
    			src: "./src/01.02.typing/assets/insert-2.png"
    		}
    	];
    ...
    /* src/01.02.typing/FormalNote.svelte generated by Svelte v3.24.1 */
    const file$x = "src/01.02.typing/FormalNote.svelte";
    ...
    function create_fragment$z(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			div2 = element("div");
    			t5 = text("Dear _______,\n        ");
    			br2 = element("br");
    			t6 = text("\n        I am writing you concerning a new opportunity. Here at Widgets co we are\n        working on a new cutting-edge system...");
    			t7 = space();
    			div6 = element("div");
    			li0 = element("li");
    			li0.textContent = "spam";
    			t9 = space();
    			li1 = element("li");
    			li1.textContent = "formality of letter-writing";
    			t11 = space();
    			li2 = element("li");
    			li2.textContent = "(unintended consequences)";
    			set_style(img, "width", "400px");
    			if (img.src !== (img_src_value = "./src/01.02.typing/assets/secretary.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$x, 45, 6, 826);
    			add_location(div0, file$x, 44, 4, 814);
    			add_location(br0, file$x, 53, 8, 1016);
    			add_location(br1, file$x, 55, 8, 1051);
    			attr_dev(div1, "class", "m2 svelte-1mvk4k5");
    			add_location(div1, file$x, 51, 6, 974);
    			add_location(br2, file$x, 60, 8, 1144);
    			attr_dev(div2, "class", "intro svelte-1mvk4k5");
    			add_location(div2, file$x, 58, 6, 1094);
    			attr_dev(div3, "class", "letter svelte-1mvk4k5");
    			add_location(div3, file$x, 50, 4, 947);
    			attr_dev(div4, "class", "row svelte-1mvk4k5");
    			add_location(div4, file$x, 43, 2, 792);
    			attr_dev(div5, "class", "box");
    			add_location(div5, file$x, 42, 0, 772);
    			add_location(li0, file$x, 69, 2, 1343);
    			add_location(li1, file$x, 70, 2, 1359);
    			add_location(li2, file$x, 71, 2, 1398);
    			attr_dev(div6, "class", "notes");
    			add_location(div6, file$x, 68, 0, 1321);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$z($$self, $$props, $$invalidate) {
    	let image = { src: "./src/01.typing/assets/spam.jpg" };
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<FormalNote> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("FormalNote", $$slots, []);
    	$$self.$capture_state = () => ({ Image, image });
    ...
    class FormalNote extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$y = "Users/spencer/mountain/somehow-timeline/src/Timeline.svelte";
    ...
    function create_fragment$A(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$y, 61, 0, 1228);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Timeline extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$A, create_fragment$A, safe_not_equal, { start: 4, end: 5, height: 6 });
    ...
    const file$z = "Users/spencer/mountain/somehow-timeline/src/shapes/Axis.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$z, 87, 4, 1888);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$B(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$z, 85, 0, 1836);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Axis extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$B, create_fragment$B, safe_not_equal, { format: 5, every: 6, size: 1, color: 0 });
    ...
    function create_fragment$C(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$A, 27, 2, 569);
    			...
    			add_location(div1, file$A, 26, 0, 461);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* Users/spencer/mountain/somehow-timeline/src/shapes/Horizontal.svelte generated by Svelte v3.24.1 */
    const file$B = "Users/spencer/mountain/somehow-timeline/src/shapes/Horizontal.svelte";
    ...
    function create_fragment$D(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$B, 46, 2, 984);
    			...
    			add_location(div1, file$B, 43, 0, 845);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$C = "Users/spencer/mountain/somehow-timeline/src/shapes/Dots.svelte";
    ...
    function create_fragment$E(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$C, 19, 6, 413);
    			...
    			add_location(pattern, file$C, 18, 4, 329);
    			add_location(defs, file$C, 17, 2, 318);
    			attr_dev(rect, "x", "0");
    			attr_dev(rect, "y", "0");
    			attr_dev(rect, "width", "100%");
    			attr_dev(rect, "height", "100%");
    			attr_dev(rect, "fill", rect_fill_value = "url(#" + /*id*/ ctx[1] + ")");
    			add_location(rect, file$C, 23, 2, 487);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$C, 16, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$D = "Users/spencer/mountain/somehow-timeline/src/shapes/Line.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$D, 106, 4, 2290);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "rotate", /*rotate*/ ctx[9]);
    			toggle_class(div, "hide", /*hide*/ ctx[2]);
    			add_location(div, file$D, 102, 4, 2198);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*label*/ ctx[6];
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$D, 119, 4, 2602);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$F(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$D, 116, 2, 2503);
    			...
    			add_location(div1, file$D, 98, 0, 2042);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    const file$E = "Users/spencer/mountain/somehow-timeline/src/shapes/Label.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$E, 96, 4, 2062);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$G(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location(div0, file$E, 99, 2, 2189);
    			...
    			add_location(div1, file$E, 100, 2, 2265);
    			...
    			add_location(div2, file$E, 90, 0, 1906);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.02.typing/ProseTimeline.svelte generated by Svelte v3.24.1 */

    const file$F = "src/01.02.typing/ProseTimeline.svelte";
    ...
    // (27:6) <Timeline start="Jan 1 1900" end="Dec 30 2020" height="600">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(27:6) <Timeline start=\\\"Jan 1 1900\\\" end=\\\"Dec 30 2020\\\" height=\\\"600\\\">",
    		ctx
    	});
    ...
    function create_fragment$H(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$F, 25, 4, 406);
    			attr_dev(div1, "class", "row svelte-ib2p5a");
    			add_location(div1, file$F, 24, 2, 384);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$F, 23, 0, 364);
    			add_location(li0, file$F, 56, 2, 1215);
    			add_location(li1, file$F, 57, 2, 1268);
    			add_location(li2, file$F, 58, 2, 1306);
    			add_location(li3, file$F, 59, 2, 1362);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$F, 55, 0, 1193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$H($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ProseTimeline> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("ProseTimeline", $$slots, []);
    ...
    class ProseTimeline extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$H, create_fragment$H, safe_not_equal, {});
    ...
    /* src/01.02.typing/Engelbart.svelte generated by Svelte v3.24.1 */

    const file$G = "src/01.02.typing/Engelbart.svelte";
    ...
    function create_fragment$I(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.02.typing/assets/engelbart/engelbart-1.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			set_style(img0, "width", "450px");
    			attr_dev(img0, "class", "svelte-1pozqn");
    			add_location(img0, file$G, 28, 6, 393);
    			attr_dev(div0, "class", "square svelte-1pozqn");
    			add_location(div0, file$G, 27, 4, 366);
    			if (img1.src !== (img1_src_value = "./src/01.02.typing/assets/engelbart/engelbart-2.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			set_style(img1, "width", "450px");
    			attr_dev(img1, "class", "svelte-1pozqn");
    			add_location(img1, file$G, 34, 6, 552);
    			attr_dev(div1, "class", "square svelte-1pozqn");
    			add_location(div1, file$G, 33, 4, 525);
    			attr_dev(div2, "class", "row svelte-1pozqn");
    			add_location(div2, file$G, 26, 2, 344);
    			if (img2.src !== (img2_src_value = "./src/01.02.typing/assets/engelbart/engelbart-3.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			set_style(img2, "width", "450px");
    			attr_dev(img2, "class", "svelte-1pozqn");
    			add_location(img2, file$G, 43, 6, 741);
    			attr_dev(div3, "class", "square svelte-1pozqn");
    			add_location(div3, file$G, 42, 4, 714);
    			attr_dev(div4, "class", "f1 grey");
    			add_location(div4, file$G, 50, 6, 929);
    			attr_dev(div5, "class", "square f2 svelte-1pozqn");
    			add_location(div5, file$G, 48, 4, 873);
    			attr_dev(div6, "class", "row svelte-1pozqn");
    			add_location(div6, file$G, 41, 2, 692);
    			attr_dev(div7, "class", "box m2 svelte-1pozqn");
    			add_location(div7, file$G, 25, 0, 321);
    			add_location(li0, file$G, 55, 2, 1010);
    			add_location(li1, file$G, 56, 2, 1046);
    			add_location(li2, file$G, 57, 2, 1077);
    			attr_dev(div8, "class", "notes");
    			add_location(div8, file$G, 54, 0, 988);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.02.typing/EngelbartApollo.svelte generated by Svelte v3.24.1 */

    const file$H = "src/01.02.typing/EngelbartApollo.svelte";
    ...
    function create_fragment$J(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div3 = element("div");
    			div3.textContent = "December 9, 1968";
    			t3 = space();
    			div5 = element("div");
    			li0 = element("li");
    			li0.textContent = "first manned-mission of Saturn V";
    			t5 = space();
    			li1 = element("li");
    			li1.textContent = "debates about the greatest machine ever built";
    			if (img0.src !== (img0_src_value = "./src/01.02.typing/assets/engelbart/engelbart-3.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			set_style(img0, "width", "450px");
    			attr_dev(img0, "class", "svelte-fzds2u");
    			add_location(img0, file$H, 34, 6, 487);
    			attr_dev(div0, "class", "square svelte-fzds2u");
    			add_location(div0, file$H, 33, 4, 460);
    			if (img1.src !== (img1_src_value = "./src/01.02.typing/assets/apollo8.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			set_style(img1, "width", "440px");
    			attr_dev(img1, "class", "svelte-fzds2u");
    			add_location(img1, file$H, 40, 6, 646);
    			attr_dev(div1, "class", "square svelte-fzds2u");
    			add_location(div1, file$H, 39, 4, 619);
    			attr_dev(div2, "class", "row svelte-fzds2u");
    			add_location(div2, file$H, 32, 2, 438);
    			attr_dev(div3, "class", "label svelte-fzds2u");
    			add_location(div3, file$H, 46, 2, 771);
    			attr_dev(div4, "class", "box m2 svelte-fzds2u");
    			add_location(div4, file$H, 31, 0, 415);
    			add_location(li0, file$H, 49, 2, 842);
    			add_location(li1, file$H, 50, 2, 886);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$H, 48, 0, 820);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$J($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<EngelbartApollo> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("EngelbartApollo", $$slots, []);
    	return [];
    }

    class EngelbartApollo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$J, create_fragment$J, safe_not_equal, {});
    ...
    /* src/01.02.typing/EngelbartMiller.svelte generated by Svelte v3.24.1 */

    const file$I = "src/01.02.typing/EngelbartMiller.svelte";
    ...
    function create_fragment$K(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div4 = element("div");
    			li0 = element("li");
    			li0.textContent = "Herman miller";
    			t3 = space();
    			li1 = element("li");
    			li1.textContent = "\"walls, desks, surfaces, everything\"";
    			t5 = space();
    			li2 = element("li");
    			li2.textContent = "6 years";
    			if (img0.src !== (img0_src_value = "./src/01.02.typing/assets/engelbart/engelbart-3.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			set_style(img0, "width", "450px");
    			attr_dev(img0, "class", "svelte-1pozqn");
    			add_location(img0, file$I, 28, 6, 393);
    			attr_dev(div0, "class", "square svelte-1pozqn");
    			add_location(div0, file$I, 27, 4, 366);
    			if (img1.src !== (img1_src_value = "./src/01.02.typing/assets/herman-miller.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			set_style(img1, "width", "360px");
    			attr_dev(img1, "class", "svelte-1pozqn");
    			add_location(img1, file$I, 34, 6, 552);
    			attr_dev(div1, "class", "square svelte-1pozqn");
    			add_location(div1, file$I, 33, 4, 525);
    			attr_dev(div2, "class", "row svelte-1pozqn");
    			add_location(div2, file$I, 26, 2, 344);
    			attr_dev(div3, "class", "box m2 svelte-1pozqn");
    			add_location(div3, file$I, 25, 0, 321);
    			add_location(li0, file$I, 42, 2, 710);
    			add_location(li1, file$I, 43, 2, 735);
    			add_location(li2, file$I, 44, 2, 783);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$I, 41, 0, 688);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$K($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<EngelbartMiller> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("EngelbartMiller", $$slots, []);
    	return [];
    }

    class EngelbartMiller extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/01.02.typing/SplitHistory.svelte generated by Svelte v3.24.1 */
    const file$J = "src/01.02.typing/SplitHistory.svelte";
    ...
    function create_fragment$L(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li = element("li");
    			if (img.src !== (img_src_value = /*image*/ ctx[0].src)) attr_dev(img, "src", img_src_value);
    			set_style(img, "box-shadow", "none");
    			attr_dev(img, "alt", "");
    			add_location(img, file$J, 12, 2, 183);
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$J, 11, 0, 163);
    			add_location(li, file$J, 16, 2, 270);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$J, 15, 0, 248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$L($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SplitHistory> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SplitHistory", $$slots, []);
    	$$self.$capture_state = () => ({ Image, image });
    ...
    class SplitHistory extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$L, create_fragment$L, safe_not_equal, {});
    ...
    /* src/01.02.typing/SDS940.svelte generated by Svelte v3.24.1 */
    const file$K = "src/01.02.typing/SDS940.svelte";
    ...
    function create_fragment$M(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li = element("li");
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$K, 7, 0, 137);
    			add_location(li, file$K, 12, 2, 208);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$K, 11, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$M($$self, $$props, $$invalidate) {
    	let image = {
    		src: "./src/01.02.typing/assets/sds940.png"
    	};

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SDS940> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SDS940", $$slots, []);
    	$$self.$capture_state = () => ({ Image, image });
    ...
    class SDS940 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$M, create_fragment$M, safe_not_equal, {});
    ...
    const file$L = "Users/spencer/mountain/somehow-keyboard/src/Keyboard.svelte";
    ...
    function create_fragment$N(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$L, 59, 4, 1212);
    			...
    			add_location(div1, file$L, 65, 4, 1407);
    			...
    			add_location(div2, file$L, 71, 4, 1593);
    			...
    			add_location(div3, file$L, 77, 4, 1779);
    			...
    			add_location(div4, file$L, 83, 4, 1965);
    			...
    			add_location(div5, file$L, 89, 4, 2151);
    			...
    			add_location(div6, file$L, 95, 4, 2337);
    			...
    			add_location(div7, file$L, 101, 4, 2523);
    			...
    			add_location(div8, file$L, 107, 4, 2709);
    			...
    			add_location(div9, file$L, 113, 4, 2895);
    			...
    			add_location(div10, file$L, 119, 4, 3081);
    			...
    			add_location(div11, file$L, 125, 4, 3267);
    			...
    			add_location(div12, file$L, 131, 4, 3453);
    			...
    			add_location(div13, file$L, 137, 4, 3639);
    			attr_dev(div14, "class", "row svelte-s6zq7o");
    			add_location(div14, file$L, 58, 2, 1190);
    			...
    			add_location(div15, file$L, 145, 4, 3872);
    			...
    			add_location(div16, file$L, 151, 4, 4066);
    			...
    			add_location(div17, file$L, 157, 4, 4252);
    			...
    			add_location(div18, file$L, 163, 4, 4438);
    			...
    			add_location(div19, file$L, 169, 4, 4624);
    			...
    			add_location(div20, file$L, 175, 4, 4810);
    			...
    			add_location(div21, file$L, 181, 4, 4996);
    			...
    			add_location(div22, file$L, 187, 4, 5182);
    			...
    			add_location(div23, file$L, 193, 4, 5368);
    			...
    			add_location(div24, file$L, 199, 4, 5554);
    			...
    			add_location(div25, file$L, 205, 4, 5740);
    			...
    			add_location(div26, file$L, 211, 4, 5926);
    			...
    			add_location(div27, file$L, 217, 4, 6112);
    			...
    			add_location(div28, file$L, 223, 4, 6298);
    			attr_dev(div29, "class", "row svelte-s6zq7o");
    			add_location(div29, file$L, 144, 2, 3850);
    			...
    			add_location(div30, file$L, 231, 4, 6517);
    			...
    			add_location(div31, file$L, 237, 4, 6725);
    			...
    			add_location(div32, file$L, 243, 4, 6911);
    			...
    			add_location(div33, file$L, 249, 4, 7097);
    			...
    			add_location(div34, file$L, 255, 4, 7283);
    			...
    			add_location(div35, file$L, 261, 4, 7469);
    			...
    			add_location(div36, file$L, 267, 4, 7655);
    			...
    			add_location(div37, file$L, 273, 4, 7841);
    			...
    			add_location(div38, file$L, 279, 4, 8028);
    			...
    			add_location(div39, file$L, 285, 4, 8214);
    			...
    			add_location(div40, file$L, 291, 4, 8400);
    			...
    			add_location(div41, file$L, 297, 4, 8586);
    			...
    			add_location(div42, file$L, 303, 4, 8772);
    			attr_dev(div43, "class", "row svelte-s6zq7o");
    			add_location(div43, file$L, 230, 2, 6495);
    			...
    			add_location(div44, file$L, 311, 4, 9013);
    			...
    			add_location(div45, file$L, 317, 4, 9229);
    			...
    			add_location(div46, file$L, 323, 4, 9414);
    			...
    			add_location(div47, file$L, 329, 4, 9599);
    			...
    			add_location(div48, file$L, 335, 4, 9784);
    			...
    			add_location(div49, file$L, 341, 4, 9969);
    			...
    			add_location(div50, file$L, 347, 4, 10154);
    			...
    			add_location(div51, file$L, 353, 4, 10339);
    			...
    			add_location(div52, file$L, 359, 4, 10524);
    			...
    			add_location(div53, file$L, 365, 4, 10709);
    			...
    			add_location(div54, file$L, 371, 4, 10894);
    			...
    			add_location(div55, file$L, 377, 4, 11079);
    			attr_dev(div56, "class", "row svelte-s6zq7o");
    			add_location(div56, file$L, 310, 2, 8991);
    			...
    			add_location(div57, file$L, 385, 4, 11324);
    			...
    			add_location(div58, file$L, 391, 4, 11536);
    			...
    			add_location(div59, file$L, 397, 4, 11744);
    			...
    			add_location(div60, file$L, 403, 4, 11952);
    			...
    			add_location(div61, file$L, 409, 4, 12164);
    			...
    			add_location(div62, file$L, 415, 4, 12372);
    			...
    			add_location(div63, file$L, 421, 4, 12580);
    			attr_dev(div64, "class", "row svelte-s6zq7o");
    			add_location(div64, file$L, 384, 2, 11302);
    			...
    			add_location(div65, file$L, 57, 0, 1112);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.02.typing/Keyboard.1.svelte generated by Svelte v3.24.1 */

    const file$M = "src/01.02.typing/Keyboard.1.svelte";
    ...
    function create_fragment$P(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			li0 = element("li");
    			li0.textContent = "attention for mouse, but choosing a typewriter input is notable";
    			t2 = space();
    			li1 = element("li");
    			li1.textContent = "children learning keyboarding in school";
    			t4 = space();
    			li2 = element("li");
    			li2.textContent = "we're maxed for keys (dexterity of hands)";
    			t6 = space();
    			li3 = element("li");
    			li3.textContent = "just english!";
    			attr_dev(div0, "class", "container svelte-1xizha2");
    			add_location(div0, file$M, 21, 2, 368);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$M, 20, 0, 348);
    			add_location(li0, file$M, 62, 2, 2137);
    			add_location(li1, file$M, 63, 2, 2212);
    			add_location(li2, file$M, 64, 2, 2263);
    			add_location(li3, file$M, 65, 2, 2316);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$M, 61, 0, 2115);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.02.typing/LightPen.svelte generated by Svelte v3.24.1 */
    const file$N = "src/01.02.typing/LightPen.svelte";
    ...
    function create_fragment$Q(ctx) {
    	...
    	let li2;
    	let current;
    	const image_spread_levels = [/*img*/ ctx[0]];
    	let image_props = {};
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			li0 = element("li");
    			li0.textContent = "not sure using typewriter-input was good-idea";
    			t2 = space();
    			li1 = element("li");
    			li1.textContent = "lightpen - 1968";
    			t4 = space();
    			li2 = element("li");
    			li2.textContent = "keyboarding being tought in schools";
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$N, 7, 0, 138);
    			add_location(li0, file$N, 12, 2, 207);
    			add_location(li1, file$N, 13, 2, 264);
    			add_location(li2, file$N, 14, 2, 291);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$N, 11, 0, 185);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			const image_changes = (dirty & /*img*/ 1)
    			? get_spread_update(image_spread_levels, [get_spread_object(/*img*/ ctx[0])])
    			: {};
    ...
    function instance$Q($$self, $$props, $$invalidate) {
    	let img = {
    		src: "./src/01.02.typing/assets/light-pen.gif"
    	};

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<LightPen> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("LightPen", $$slots, []);
    	$$self.$capture_state = () => ({ Image, img });
    ...
    class LightPen extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$Q, create_fragment$Q, safe_not_equal, {});
    ...
    /* src/01.02.typing/index.svelte generated by Svelte v3.24.1 */
    ...
    function instance$R($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<_01_02_typing> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("_01_02_typing", $$slots, []);
    ...
    class _01_02_typing extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$R, create_fragment$R, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "_01_02_typing",
    			options,
    			id: create_fragment$R.name
    		});
    	}
    	...
    	get done() {
    		throw new Error("<_01_02_typing>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set done(value) {
    		throw new Error("<_01_02_typing>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    const file$O = "src/01.punctuation/Keyboard.2.svelte";
    ...
    function create_fragment$S(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container svelte-1xizha2");
    			add_location(div0, file$O, 21, 2, 368);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$O, 20, 0, 348);
    			add_location(li0, file$O, 64, 2, 2048);
    			add_location(li1, file$O, 65, 2, 2090);
    			add_location(li2, file$O, 66, 2, 2137);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$O, 63, 0, 2026);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$P = "src/01.punctuation/Keyboard.3.svelte";
    ...
    function create_fragment$T(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container svelte-1xizha2");
    			add_location(div0, file$P, 21, 2, 368);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$P, 20, 0, 348);
    			add_location(li, file$P, 64, 2, 2188);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$P, 63, 0, 2166);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$Q = "src/01.punctuation/KeyTilde.svelte";
    ...
    function create_fragment$U(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "pink");
    			add_location(div0, file$Q, 59, 4, 1050);
    			attr_dev(div1, "class", "desc svelte-gvw6fu");
    			add_location(div1, file$Q, 60, 4, 1086);
    			attr_dev(div2, "class", "topWord svelte-gvw6fu");
    			add_location(div2, file$Q, 58, 2, 1024);
    			attr_dev(div3, "class", "container svelte-gvw6fu");
    			add_location(div3, file$Q, 62, 2, 1130);
    			attr_dev(div4, "class", "blue");
    			add_location(div4, file$Q, 104, 6, 3079);
    			attr_dev(div5, "class", "desc svelte-gvw6fu");
    			add_location(div5, file$Q, 105, 6, 3119);
    			add_location(div6, file$Q, 103, 4, 3067);
    			attr_dev(div7, "class", "red");
    			add_location(div7, file$Q, 108, 6, 3182);
    			attr_dev(div8, "class", "desc svelte-gvw6fu");
    			add_location(div8, file$Q, 109, 6, 3217);
    			add_location(div9, file$Q, 107, 4, 3170);
    			attr_dev(div10, "class", "bottom svelte-gvw6fu");
    			add_location(div10, file$Q, 102, 2, 3042);
    			attr_dev(div11, "class", "box");
    			add_location(div11, file$Q, 57, 0, 1004);
    			add_location(li0, file$Q, 115, 2, 3299);
    			add_location(li1, file$Q, 116, 2, 3346);
    			add_location(li2, file$Q, 117, 2, 3373);
    			attr_dev(div12, "class", "notes");
    			add_location(div12, file$Q, 114, 0, 3277);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$R = "src/01.punctuation/KeyTilde2.svelte";
    ...
    function create_fragment$V(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$R, 67, 4, 1150);
    			attr_dev(div0, "class", "topImg svelte-10xq6vl");
    			add_location(div0, file$R, 66, 2, 1125);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$R, 64, 0, 1104);
    			add_location(li0, file$R, 73, 2, 1249);
    			add_location(li1, file$R, 74, 2, 1279);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$R, 72, 0, 1227);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$S = "src/01.punctuation/KeyHash.svelte";
    ...
    function create_fragment$W(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "pink");
    			add_location(div0, file$S, 59, 4, 1050);
    			attr_dev(div1, "class", "desc svelte-gvw6fu");
    			add_location(div1, file$S, 60, 4, 1085);
    			attr_dev(div2, "class", "topWord svelte-gvw6fu");
    			add_location(div2, file$S, 58, 2, 1024);
    			attr_dev(div3, "class", "container svelte-gvw6fu");
    			add_location(div3, file$S, 62, 2, 1129);
    			attr_dev(div4, "class", "blue");
    			add_location(div4, file$S, 104, 6, 3078);
    			attr_dev(div5, "class", "desc svelte-gvw6fu");
    			add_location(div5, file$S, 105, 6, 3115);
    			add_location(div6, file$S, 103, 4, 3066);
    			attr_dev(div7, "class", "red");
    			add_location(div7, file$S, 108, 6, 3178);
    			attr_dev(div8, "class", "desc svelte-gvw6fu");
    			add_location(div8, file$S, 109, 6, 3216);
    			add_location(div9, file$S, 107, 4, 3166);
    			attr_dev(div10, "class", "bottom svelte-gvw6fu");
    			add_location(div10, file$S, 102, 2, 3041);
    			attr_dev(div11, "class", "box");
    			add_location(div11, file$S, 57, 0, 1004);
    			add_location(li0, file$S, 115, 2, 3298);
    			add_location(li1, file$S, 116, 2, 3324);
    			add_location(li2, file$S, 117, 2, 3376);
    			add_location(li3, file$S, 118, 2, 3400);
    			attr_dev(div12, "class", "notes");
    			add_location(div12, file$S, 114, 0, 3276);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$T = "src/01.punctuation/KeyAt.svelte";
    ...
    function create_fragment$X(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "pink");
    			add_location(div0, file$T, 59, 4, 1050);
    			attr_dev(div1, "class", "desc svelte-1gvmhr9");
    			add_location(div1, file$T, 60, 4, 1092);
    			attr_dev(div2, "class", "topWord svelte-1gvmhr9");
    			add_location(div2, file$T, 58, 2, 1024);
    			attr_dev(div3, "class", "container svelte-1gvmhr9");
    			add_location(div3, file$T, 62, 2, 1136);
    			attr_dev(div4, "class", "blue");
    			add_location(div4, file$T, 104, 6, 3085);
    			attr_dev(div5, "class", "desc svelte-1gvmhr9");
    			add_location(div5, file$T, 105, 6, 3128);
    			add_location(div6, file$T, 103, 4, 3073);
    			attr_dev(div7, "class", "red");
    			add_location(div7, file$T, 108, 6, 3191);
    			attr_dev(div8, "class", "desc svelte-1gvmhr9");
    			add_location(div8, file$T, 109, 6, 3229);
    			add_location(div9, file$T, 107, 4, 3179);
    			attr_dev(div10, "class", "bottom svelte-1gvmhr9");
    			add_location(div10, file$T, 102, 2, 3048);
    			attr_dev(div11, "class", "box");
    			add_location(div11, file$T, 57, 0, 1004);
    			add_location(li0, file$T, 115, 2, 3311);
    			add_location(li1, file$T, 116, 2, 3350);
    			add_location(li2, file$T, 117, 2, 3383);
    			add_location(li3, file$T, 118, 2, 3405);
    			add_location(li4, file$T, 119, 2, 3474);
    			attr_dev(div12, "class", "notes");
    			add_location(div12, file$T, 114, 0, 3289);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$U = "src/01.punctuation/KeyAsterix.svelte";
    ...
    function create_fragment$Y(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "pink");
    			add_location(div0, file$U, 59, 4, 1050);
    			attr_dev(div1, "class", "desc svelte-1gvmhr9");
    			add_location(div1, file$U, 60, 4, 1084);
    			attr_dev(div2, "class", "topWord svelte-1gvmhr9");
    			add_location(div2, file$U, 58, 2, 1024);
    			attr_dev(div3, "class", "container svelte-1gvmhr9");
    			add_location(div3, file$U, 62, 2, 1128);
    			attr_dev(div4, "class", "blue");
    			set_style(div4, "font-family", "monospace");
    			add_location(div4, file$U, 104, 6, 3077);
    			attr_dev(div5, "class", "desc svelte-1gvmhr9");
    			add_location(div5, file$U, 105, 6, 3149);
    			add_location(div6, file$U, 103, 4, 3065);
    			attr_dev(div7, "class", "red");
    			add_location(div7, file$U, 108, 6, 3212);
    			attr_dev(div8, "class", "desc svelte-1gvmhr9");
    			add_location(div8, file$U, 109, 6, 3248);
    			add_location(div9, file$U, 107, 4, 3200);
    			attr_dev(div10, "class", "bottom svelte-1gvmhr9");
    			add_location(div10, file$U, 102, 2, 3040);
    			attr_dev(div11, "class", "box");
    			add_location(div11, file$U, 57, 0, 1004);
    			add_location(li0, file$U, 115, 2, 3330);
    			add_location(li1, file$U, 116, 2, 3363);
    			add_location(li2, file$U, 117, 2, 3389);
    			attr_dev(div12, "class", "notes");
    			add_location(div12, file$U, 114, 0, 3308);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$V = "src/01.punctuation/KeyBrackets.svelte";
    ...
    function create_fragment$Z(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$V, 64, 2, 2272);
    			add_location(li1, file$V, 65, 2, 2307);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$V, 63, 0, 2250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$W = "src/01.punctuation/Tomlinson.svelte";
    ...
    function create_fragment$_(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$W, 19, 6, 309);
    			attr_dev(div0, "class", "");
    			add_location(div0, file$W, 18, 4, 288);
    			set_style(div1, "width", "300px");
    			set_style(div1, "font-size", "1.4rem");
    			attr_dev(div1, "class", "");
    			add_location(div1, file$W, 24, 4, 430);
    			attr_dev(div2, "class", "row svelte-ssqihk");
    			add_location(div2, file$W, 17, 2, 266);
    			attr_dev(div3, "class", "box");
    			add_location(div3, file$W, 16, 0, 246);
    			add_location(li0, file$W, 30, 2, 597);
    			add_location(li1, file$W, 31, 2, 622);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$W, 29, 0, 575);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/01.punctuation/Escaping.svelte generated by Svelte v3.24.1 */
    const file$X = "src/01.punctuation/Escaping.svelte";
    ...
    function create_fragment$$(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$X, 7, 0, 142);
    			add_location(li, file$X, 12, 2, 213);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$X, 11, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class _01_punctuation extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$10, create_fragment$10, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    const file$Y = "src/02.markup/Question.svelte";
    ...
    function create_fragment$11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$Y, 23, 4, 296);
    			attr_dev(span0, "class", "blue med  svelte-10y1wyx");
    			add_location(span0, file$Y, 25, 6, 363);
    			attr_dev(span1, "class", "red i");
    			add_location(span1, file$Y, 26, 6, 405);
    			attr_dev(div1, "class", "blue med  svelte-10y1wyx");
    			add_location(div1, file$Y, 27, 6, 443);
    			attr_dev(div2, "class", "med svelte-10y1wyx");
    			add_location(div2, file$Y, 24, 4, 339);
    			add_location(div3, file$Y, 22, 2, 286);
    			attr_dev(div4, "class", "box big svelte-10y1wyx");
    			add_location(div4, file$Y, 21, 0, 262);
    			add_location(li, file$Y, 32, 2, 542);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$Y, 31, 0, 520);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$_ = "src/02.markup/MarkupQuestion.svelte";
    ...
    function create_fragment$13(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$_, 20, 4, 217);
    			attr_dev(div1, "class", "red i");
    			add_location(div1, file$_, 22, 6, 286);
    			attr_dev(span0, "class", "blue f3 svelte-3w2vdo");
    			add_location(span0, file$_, 23, 6, 324);
    			attr_dev(span1, "class", "med svelte-3w2vdo");
    			add_location(span1, file$_, 21, 4, 261);
    			add_location(div2, file$_, 19, 2, 207);
    			attr_dev(div3, "class", "box big svelte-3w2vdo");
    			add_location(div3, file$_, 18, 0, 183);
    			add_location(li0, file$_, 28, 2, 420);
    			add_location(li1, file$_, 29, 2, 459);
    			add_location(li2, file$_, 30, 2, 485);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$_, 27, 0, 398);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$$ = "src/02.markup/Margin.svelte";
    ...
    function create_fragment$14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$$, 9, 0, 180);
    			add_location(li0, file$$, 14, 2, 251);
    			add_location(li1, file$$, 15, 2, 291);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$$, 13, 0, 229);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/02.markup/ArchieML.svelte generated by Svelte v3.24.1 */
    const file$10 = "src/02.markup/ArchieML.svelte";
    ...
    function create_fragment$15(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$10, 9, 0, 177);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$10, 13, 0, 226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$15($$self, $$props, $$invalidate) {
    	let image = {
    		src: "./src/02.markup/assets/archie.png",
    		title: "ArchieML",
    		sub: "NYTimes"
    	};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ArchieML> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("ArchieML", $$slots, []);
    	$$self.$capture_state = () => ({ Image, image });
    ...
    class ArchieML extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$11 = "src/02.markup/Glimpse.svelte";
    ...
    function create_fragment$16(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			li0 = element("li");
    			li0.textContent = "ACM conference in 2011";
    			t2 = space();
    			li1 = element("li");
    			li1.textContent = "giving-up on wysiwyg";
    			attr_dev(div0, "class", "box");
    			add_location(div0, file$11, 14, 0, 267);
    			add_location(li0, file$11, 18, 2, 349);
    			add_location(li1, file$11, 19, 2, 383);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$11, 17, 0, 327);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$12 = "src/02.markup/Timeline.svelte";
    ...
    // (36:6) <Timeline start="Jan 1 1900" end="Dec 30 2020" height="600">
    function create_default_slot$9(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:6) <Timeline start=\\\"Jan 1 1900\\\" end=\\\"Dec 30 2020\\\" height=\\\"600\\\">",
    		ctx
    	});
    ...
    function create_fragment$17(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "width", "400px");
    			add_location(div0, file$12, 34, 4, 596);
    			attr_dev(div1, "class", "row svelte-u9qx7l");
    			add_location(div1, file$12, 33, 2, 574);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$12, 32, 0, 554);
    			add_location(li0, file$12, 62, 2, 1369);
    			add_location(li1, file$12, 63, 2, 1419);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$12, 61, 0, 1347);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$13 = "src/02.markup/Loop.svelte";
    ...
    function create_fragment$18(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$13, 66, 10, 1600);
    			...
    			add_location(marker0, file$13, 57, 8, 1376);
    			...
    			add_location(path1, file$13, 81, 10, 1995);
    			...
    			add_location(marker1, file$13, 72, 8, 1770);
    			add_location(defs, file$13, 56, 6, 1361);
    			...
    			add_location(path2, file$13, 88, 6, 2177);
    			...
    			add_location(path3, file$13, 95, 6, 2521);
    			attr_dev(svg, "viewBox", "-50,-50,100,100");
    			attr_dev(svg, "shape-rendering", "geometricPrecision");
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$13, 51, 4, 1235);
    			attr_dev(div8, "class", "col svelte-1750xxe");
    			set_style(div8, "transform", "scaleX(-1)");
    			set_style(div8, "height", "600px");
    			add_location(div8, file$13, 49, 2, 1168);
    			attr_dev(div9, "class", "box");
    			set_style(div9, "position", "relative");
    			set_style(div9, "with", "100%");
    			add_location(div9, file$13, 31, 0, 513);
    			add_location(li0, file$13, 109, 2, 2908);
    			add_location(li1, file$13, 110, 2, 2972);
    			attr_dev(div10, "class", "notes");
    			add_location(div10, file$13, 108, 0, 2886);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$14 = "src/02.markup/LoopPink.svelte";
    ...
    function create_fragment$19(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$14, 43, 4, 756);
    			add_location(div1, file$14, 44, 4, 782);
    			add_location(div2, file$14, 45, 4, 812);
    			add_location(div3, file$14, 46, 4, 836);
    			add_location(div4, file$14, 47, 4, 865);
    			add_location(div5, file$14, 48, 4, 898);
    			add_location(div6, file$14, 49, 4, 931);
    			add_location(div7, file$14, 50, 4, 965);
    			attr_dev(div8, "class", "onleft svelte-sbsgm0");
    			add_location(div8, file$14, 42, 2, 731);
    			attr_dev(div9, "class", "label pink svelte-sbsgm0");
    			set_style(div9, "top", "40%");
    			set_style(div9, "left", "34%");
    			add_location(div9, file$14, 52, 2, 1000);
    			set_style(div10, "opacity", "0");
    			add_location(div10, file$14, 54, 4, 1111);
    			attr_dev(div11, "class", "f2 blue");
    			add_location(div11, file$14, 55, 4, 1152);
    			attr_dev(div12, "class", "label red svelte-sbsgm0");
    			set_style(div12, "top", "40%");
    			set_style(div12, "left", "24%");
    			add_location(div12, file$14, 53, 2, 1056);
    			add_location(br, file$14, 59, 4, 1308);
    			attr_dev(div13, "class", "f2");
    			add_location(div13, file$14, 60, 4, 1319);
    			attr_dev(div14, "class", "label red svelte-sbsgm0");
    			set_style(div14, "top", "40%");
    			set_style(div14, "left", "57%");
    			add_location(div14, file$14, 57, 2, 1194);
    			attr_dev(span0, "class", "sub i  svelte-sbsgm0");
    			set_style(span0, "font-size", "1.2rem");
    			add_location(span0, file$14, 63, 4, 1403);
    			add_location(div15, file$14, 64, 4, 1474);
    			attr_dev(div16, "class", "label blue svelte-sbsgm0");
    			set_style(div16, "top", "50px");
    			add_location(div16, file$14, 62, 2, 1356);
    			attr_dev(span1, "class", "sub i  svelte-sbsgm0");
    			set_style(span1, "font-size", "1.2rem");
    			add_location(span1, file$14, 67, 4, 1561);
    			add_location(div17, file$14, 68, 4, 1629);
    			attr_dev(div18, "class", "label red svelte-sbsgm0");
    			set_style(div18, "bottom", "50px");
    			add_location(div18, file$14, 66, 2, 1512);
    			attr_dev(path0, "d", "M 0 0 L 10 4 L 0 10 z");
    			attr_dev(path0, "fill", "#D68881");
    			attr_dev(path0, "transform", "rotate(23)");
    			attr_dev(path0, "class", "svelte-1lnhtnf");
    			add_location(path0, file$14, 87, 10, 2094);
    			attr_dev(marker0, "id", "triangle");
    			attr_dev(marker0, "viewBox", "0 0 10 10");
    			attr_dev(marker0, "refX", "4");
    			attr_dev(marker0, "refY", "6");
    			...
    			attr_dev(marker0, "markerHeight", "9");
    			attr_dev(marker0, "orient", "auto");
    			add_location(marker0, file$14, 78, 8, 1870);
    			attr_dev(path1, "d", "M 0 0 L 10 4 L 0 10 z");
    			attr_dev(path1, "fill", "#6699cc");
    			attr_dev(path1, "transform", "rotate(23)");
    			attr_dev(path1, "class", "svelte-1lnhtnf");
    			add_location(path1, file$14, 102, 10, 2489);
    			attr_dev(marker1, "id", "triangle2");
    			attr_dev(marker1, "viewBox", "0 0 10 10");
    			attr_dev(marker1, "refX", "4");
    			attr_dev(marker1, "refY", "6");
    			...
    			attr_dev(marker1, "markerHeight", "9");
    			attr_dev(marker1, "orient", "auto");
    			add_location(marker1, file$14, 93, 8, 2264);
    			add_location(defs, file$14, 77, 6, 1855);
    			attr_dev(path2, "class", "link svelte-1lnhtnf");
    			attr_dev(path2, "d", "M30.8144647592461,-14.369020899183779A34,34,0,0,0,-32.84147809382832,-8.7998475334857L-30.909626441250186,-8.282209443280658A32,32,0,0,1,29.0018491851728,-13.52378437570238Z");
    			attr_dev(path2, "stroke", "none");
    			attr_dev(path2, "fill", "#6699cc");
    			attr_dev(path2, "stroke-width", "1");
    			attr_dev(path2, "marker-end", "url(#triangle2)");
    			add_location(path2, file$14, 109, 6, 2671);
    			attr_dev(path3, "class", "link svelte-1lnhtnf");
    			attr_dev(path3, "d", "M-32.84147809382832,8.7998475334857A34,34,0,0,0,32.84147809382832,8.799847533485696L30.909626441250186,8.282209443280655A32,32,0,0,1,-30.909626441250186,8.282209443280658Z");
    			attr_dev(path3, "stroke", "none");
    			attr_dev(path3, "fill", "#D68881");
    			attr_dev(path3, "stroke-width", "1");
    			attr_dev(path3, "marker-end", "url(#triangle)");
    			add_location(path3, file$14, 116, 6, 3015);
    			...
    			add_location(path4, file$14, 126, 8, 3418);
    			...
    			add_location(path5, file$14, 132, 8, 3737);
    			attr_dev(g, "transform", "scale(0.8)");
    			add_location(g, file$14, 125, 6, 3383);
    			attr_dev(svg, "viewBox", "-50,-50,100,100");
    			attr_dev(svg, "shape-rendering", "geometricPrecision");
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$14, 72, 4, 1729);
    			attr_dev(div19, "class", "col svelte-sbsgm0");
    			set_style(div19, "transform", "scaleX(-1)");
    			set_style(div19, "height", "600px");
    			add_location(div19, file$14, 70, 2, 1662);
    			attr_dev(div20, "class", "box");
    			set_style(div20, "position", "relative");
    			set_style(div20, "width", "100%");
    			add_location(div20, file$14, 40, 0, 671);
    			add_location(li, file$14, 146, 2, 4109);
    			attr_dev(div21, "class", "notes");
    			add_location(div21, file$14, 145, 0, 4087);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$15 = "src/02.markup/LoopNLP.svelte";
    ...
    function create_fragment$1a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$15, 34, 4, 628);
    			attr_dev(div1, "class", "f2 blue");
    			add_location(div1, file$15, 35, 4, 669);
    			attr_dev(div2, "class", "label red svelte-d5szif");
    			set_style(div2, "top", "40%");
    			set_style(div2, "left", "24%");
    			add_location(div2, file$15, 33, 2, 573);
    			set_style(div3, "opacity", "0");
    			add_location(div3, file$15, 38, 4, 766);
    			attr_dev(div4, "class", "f2");
    			add_location(div4, file$15, 39, 4, 807);
    			attr_dev(div5, "class", "label red svelte-d5szif");
    			set_style(div5, "top", "40%");
    			set_style(div5, "left", "57%");
    			add_location(div5, file$15, 37, 2, 711);
    			attr_dev(span0, "class", "sub i  svelte-d5szif");
    			set_style(span0, "font-size", "1.2rem");
    			add_location(span0, file$15, 42, 4, 900);
    			attr_dev(div6, "class", "f2");
    			add_location(div6, file$15, 43, 4, 973);
    			attr_dev(span1, "class", "sub i  svelte-d5szif");
    			set_style(span1, "font-size", "1.2rem");
    			add_location(span1, file$15, 44, 4, 1003);
    			attr_dev(div7, "class", "label green svelte-d5szif");
    			set_style(div7, "top", "58%");
    			set_style(div7, "left", "7%");
    			add_location(div7, file$15, 41, 2, 844);
    			attr_dev(path0, "d", "M 0 0 L 10 4 L 0 10 z");
    			attr_dev(path0, "fill", "#D68881");
    			attr_dev(path0, "transform", "rotate(23)");
    			attr_dev(path0, "class", "svelte-1lnhtnf");
    			add_location(path0, file$15, 64, 10, 1511);
    			attr_dev(marker0, "id", "triangle");
    			attr_dev(marker0, "viewBox", "0 0 10 10");
    			attr_dev(marker0, "refX", "4");
    			attr_dev(marker0, "refY", "6");
    			...
    			attr_dev(marker0, "markerHeight", "9");
    			attr_dev(marker0, "orient", "auto");
    			add_location(marker0, file$15, 55, 8, 1287);
    			attr_dev(path1, "d", "M 0 0 L 10 4 L 0 10 z");
    			attr_dev(path1, "fill", "#6699cc");
    			attr_dev(path1, "transform", "rotate(23)");
    			attr_dev(path1, "class", "svelte-1lnhtnf");
    			add_location(path1, file$15, 79, 10, 1906);
    			attr_dev(marker1, "id", "triangle2");
    			attr_dev(marker1, "viewBox", "0 0 10 10");
    			attr_dev(marker1, "refX", "4");
    			attr_dev(marker1, "refY", "6");
    			...
    			attr_dev(marker1, "markerHeight", "9");
    			attr_dev(marker1, "orient", "auto");
    			add_location(marker1, file$15, 70, 8, 1681);
    			...
    			add_location(path2, file$15, 94, 10, 2301);
    			...
    			add_location(marker2, file$15, 85, 8, 2076);
    			add_location(defs, file$15, 54, 6, 1272);
    			attr_dev(path3, "class", "link svelte-1lnhtnf");
    			...
    			add_location(path3, file$15, 101, 6, 2483);
    			attr_dev(path4, "class", "link svelte-1lnhtnf");
    			...
    			add_location(path4, file$15, 108, 6, 2827);
    			attr_dev(path5, "class", "link svelte-1lnhtnf");
    			...
    			add_location(path5, file$15, 117, 8, 3236);
    			set_style(g, "scale", "-1 1");
    			set_style(g, "transform", "translate(-70px, 6px)");
    			add_location(g, file$15, 116, 6, 3169);
    			attr_dev(svg, "viewBox", "-50,-50,100,100");
    			attr_dev(svg, "shape-rendering", "geometricPrecision");
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$15, 49, 4, 1146);
    			attr_dev(div8, "class", "col svelte-d5szif");
    			set_style(div8, "transform", "scaleX(-1)");
    			set_style(div8, "height", "600px");
    			add_location(div8, file$15, 47, 2, 1079);
    			attr_dev(div9, "class", "box");
    			set_style(div9, "position", "relative");
    			set_style(div9, "width", "100%");
    			add_location(div9, file$15, 31, 0, 513);
    			add_location(li0, file$15, 131, 2, 3647);
    			add_location(li1, file$15, 132, 2, 3673);
    			add_location(li2, file$15, 133, 2, 3698);
    			attr_dev(div10, "class", "notes");
    			add_location(div10, file$15, 130, 0, 3625);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$16 = "src/02.markup/Newline.svelte";
    ...
    function create_fragment$1b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			li1 = element("li");
    			li1.textContent = "(Samuel Morse)";
    			t7 = space();
    			li2 = element("li");
    			li2.textContent = "punchcards had an overflow character";
    			t9 = space();
    			li3 = element("li");
    			li3.textContent = "typewriter RUNOFF";
    			t11 = space();
    			li4 = element("li");
    			li4.textContent = "there is no plaintext.";
    			attr_dev(div0, "class", "box f4 svelte-1d5z98v");
    			add_location(div0, file$16, 11, 0, 99);
    			add_location(i, file$16, 16, 4, 175);
    			add_location(li0, file$16, 14, 2, 156);
    			add_location(li1, file$16, 19, 2, 223);
    			add_location(li2, file$16, 20, 2, 249);
    			add_location(li3, file$16, 21, 2, 297);
    			add_location(li4, file$16, 22, 2, 326);
    			attr_dev(div1, "class", "notes");
    			add_location(div1, file$16, 13, 0, 134);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class _02_markup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1c, create_fragment$1c, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    /* src/03.word-wrap/Monospace.svelte generated by Svelte v3.24.1 */
    const file$17 = "src/03.word-wrap/Monospace.svelte";
    ...
    function create_fragment$1d(ctx) {
    	...
    	let br5;
    	let current;
    	const image_spread_levels = [/*images*/ ctx[0]];
    	let image_props = {};
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			div1 = element("div");
    			t1 = text("O R A N G E S\n      ");
    			br0 = element("br");
    			t2 = space();
    			span0 = element("span");
    			span0.textContent = "A P P L E S";
    			t4 = space();
    			br1 = element("br");
    			t5 = text("\n      B A N A N A S\n      ");
    			br2 = element("br");
    			t6 = space();
    			span1 = element("span");
    			span1.textContent = "S O U P";
    			t8 = space();
    			br3 = element("br");
    			t9 = space();
    			span2 = element("span");
    			span2.textContent = "P R O D U C E";
    			t11 = space();
    			br4 = element("br");
    			t12 = space();
    			span3 = element("span");
    			span3.textContent = "    C A R R O T S";
    			t14 = space();
    			br5 = element("br");
    			set_style(div0, "width", "600px");
    			add_location(div0, file$17, 32, 4, 588);
    			add_location(br0, file$17, 37, 6, 702);
    			attr_dev(span0, "class", "green svelte-907f1c");
    			add_location(span0, file$17, 38, 6, 715);
    			add_location(br1, file$17, 39, 6, 760);
    			add_location(br2, file$17, 41, 6, 793);
    			attr_dev(span1, "class", "green svelte-907f1c");
    			add_location(span1, file$17, 42, 6, 806);
    			add_location(br3, file$17, 43, 6, 847);
    			attr_dev(span2, "class", "brown");
    			add_location(span2, file$17, 44, 6, 860);
    			add_location(br4, file$17, 45, 6, 907);
    			attr_dev(span3, "class", "orange");
    			add_location(span3, file$17, 46, 6, 920);
    			add_location(br5, file$17, 47, 6, 987);
    			attr_dev(div1, "class", "mono svelte-907f1c");
    			add_location(div1, file$17, 35, 4, 657);
    			attr_dev(div2, "class", "row svelte-907f1c");
    			add_location(div2, file$17, 31, 2, 566);
    			attr_dev(div3, "class", "box");
    			add_location(div3, file$17, 30, 0, 546);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			const image_changes = (dirty & /*images*/ 1)
    			? get_spread_update(image_spread_levels, [get_spread_object(/*images*/ ctx[0])])
    			: {};
    ...
    function instance$1d($$self, $$props, $$invalidate) {
    	let images = {
    		src: "./src/01.02.typing/assets/engelbart/engelbart-1.png"
    	};

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Monospace> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Monospace", $$slots, []);
    	$$self.$capture_state = () => ({ Image, images });
    ...
    class Monospace extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$18 = "src/03.word-wrap/Spreadsheet.svelte";
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$18, 60, 6, 1276);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$18, 69, 10, 1563);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(div, "class", "cell svelte-10qh3b4");
    			add_location(div, file$18, 67, 10, 1496);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*content*/ ctx[0][/*i*/ ctx[6]] && /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]]) return create_if_block$4;
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$18, 64, 6, 1375);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$1e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$18, 58, 4, 1207);
    			attr_dev(div1, "class", "container svelte-10qh3b4");
    			add_location(div1, file$18, 56, 2, 1158);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$18, 55, 0, 1138);
    			add_location(li, file$18, 77, 2, 1663);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$18, 76, 0, 1641);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/03.word-wrap/SpreadsheetSelect.svelte generated by Svelte v3.24.1 */

    const file$19 = "src/03.word-wrap/SpreadsheetSelect.svelte";
    ...
    function create_each_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(div, "class", "cell top svelte-10qh3b4");
    			add_location(div, file$19, 60, 6, 1276);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "cell svelte-10qh3b4");
    			add_location(div, file$19, 75, 10, 1775);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block$5(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*i*/ ctx[6] === 4 && /*i2*/ ctx[9] === 14 && /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]] === "e") return create_if_block_1$1;
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(div, "class", "cell svelte-10qh3b4");
    			add_location(div, file$19, 72, 12, 1692);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    // (68:10) {#if i === 4 && i2 === 14 && content[i][i2] === 'e'}
    function create_if_block_1$1(ctx) {
    	let div;
    	let t0_value = /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(div, "class", "cell svelte-10qh3b4");
    			set_style(div, "border", "4px solid black");
    			add_location(div, file$19, 68, 12, 1561);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*content*/ 1 && t0_value !== (t0_value = /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(68:10) {#if i === 4 && i2 === 14 && content[i][i2] === 'e'}",
    		ctx
    	});
    ...
    function create_each_block_1$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*content*/ ctx[0][/*i*/ ctx[6]] && /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]]) return create_if_block$5;
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(div, "class", "cell num svelte-10qh3b4");
    			add_location(div, file$19, 64, 6, 1375);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$1f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li.textContent = "typewriter was 2D (carriage+scroll)";
    			attr_dev(div0, "class", "cell num top svelte-10qh3b4");
    			add_location(div0, file$19, 58, 4, 1207);
    			attr_dev(div1, "class", "container svelte-10qh3b4");
    			add_location(div1, file$19, 56, 2, 1158);
    			attr_dev(div2, "class", "box");
    			add_location(div2, file$19, 55, 0, 1138);
    			add_location(li, file$19, 83, 2, 1875);
    			attr_dev(div3, "class", "notes");
    			add_location(div3, file$19, 82, 0, 1853);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1f($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SpreadsheetSelect> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SpreadsheetSelect", $$slots, []);
    	$$self.$capture_state = () => ({ rows, cols, content, letters });
    ...
    class SpreadsheetSelect extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$1a = "src/03.word-wrap/Wrap.svelte";
    ...
    function create_fragment$1g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			track = element("track");
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1a, 15, 4, 295);
    			attr_dev(video_1, "class", "vid");
    			if (video_1.src !== (video_1_src_value = /*video*/ ctx[0].src)) attr_dev(video_1, "src", video_1_src_value);
    			video_1.loop = true;
    			video_1.autoplay = true;
    			video_1.muted = true;
    			add_location(video_1, file$1a, 14, 2, 235);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1a, 13, 0, 215);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/03.word-wrap/Poe.svelte generated by Svelte v3.24.1 */
    const file$1b = "src/03.word-wrap/Poe.svelte";
    ...
    function create_fragment$1h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			track = element("track");
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1b, 13, 4, 305);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1b, 12, 2, 253);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1b, 10, 0, 176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1h($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Poe> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Poe", $$slots, []);
    	$$self.$capture_state = () => ({ Video, wait, src });
    ...
    class Poe extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/03.word-wrap/VariableWidth.svelte generated by Svelte v3.24.1 */
    const file$1c = "src/03.word-wrap/VariableWidth.svelte";
    ...
    function create_fragment$1i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			track = element("track");
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1c, 15, 4, 300);
    			attr_dev(video_1, "class", "vid");
    			if (video_1.src !== (video_1_src_value = /*video*/ ctx[0].src)) attr_dev(video_1, "src", video_1_src_value);
    			video_1.loop = true;
    			video_1.autoplay = true;
    			video_1.muted = true;
    			add_location(video_1, file$1c, 14, 2, 240);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1c, 13, 0, 220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1i($$self, $$props, $$invalidate) {
    	let video = {
    		src: "./src/03.word-wrap/assets/variable-width.mp4",
    		loop: true
    	};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<VariableWidth> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("VariableWidth", $$slots, []);
    	$$self.$capture_state = () => ({ Video, wait, video });
    ...
    class VariableWidth extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/03.word-wrap/NotSpreadsheet.svelte generated by Svelte v3.24.1 */

    const file$1d = "src/03.word-wrap/NotSpreadsheet.svelte";
    ...
    function create_each_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "cell top svelte-1mfle73");
    			add_location(div, file$1d, 86, 6, 1859);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(86:4) {#each Array(cols) as _2, i2}",
    		ctx
    	});
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "cell svelte-1mfle73");
    			add_location(div, file$1d, 95, 10, 2146);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (93:8) {#if content[i] && content[i][i2]}
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(div, "class", "cell svelte-1mfle73");
    			add_location(div, file$1d, 93, 10, 2079);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(93:8) {#if content[i] && content[i][i2]}",
    		ctx
    	});
    ...
    // (92:6) {#each Array(cols) as _2, i2}
    function create_each_block_1$2(ctx) {
    	let if_block_anchor;

    	function select_block_type(ctx, dirty) {
    		if (/*content*/ ctx[0][/*i*/ ctx[6]] && /*content*/ ctx[0][/*i*/ ctx[6]][/*i2*/ ctx[9]]) return create_if_block$6;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(92:6) {#each Array(cols) as _2, i2}",
    		ctx
    	});
    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(div, "class", "cell num svelte-1mfle73");
    			add_location(div, file$1d, 90, 6, 1958);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(90:4) {#each Array(rows) as _, i}",
    		ctx
    	});
    ...
    function create_fragment$1j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div0 = element("div");
    			div0.textContent = "✗ append-mode";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "✗ word-wrap";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "✗ variable-width fonts";
    			t5 = space();
    			div5 = element("div");
    			t6 = space();
    			...
    			div8 = element("div");
    			li = element("li");
    			li.textContent = "complex datastructure required";
    			add_location(div0, file$1d, 78, 8, 1643);
    			add_location(div1, file$1d, 79, 8, 1676);
    			add_location(div2, file$1d, 80, 8, 1707);
    			attr_dev(div3, "class", "diff i svelte-1mfle73");
    			add_location(div3, file$1d, 77, 6, 1614);
    			attr_dev(div4, "class", "overlay svelte-1mfle73");
    			add_location(div4, file$1d, 76, 4, 1586);
    			attr_dev(div5, "class", "cell num top svelte-1mfle73");
    			add_location(div5, file$1d, 84, 4, 1790);
    			attr_dev(div6, "class", "container svelte-1mfle73");
    			add_location(div6, file$1d, 75, 2, 1558);
    			attr_dev(div7, "class", "box");
    			add_location(div7, file$1d, 74, 0, 1538);
    			add_location(li, file$1d, 103, 2, 2246);
    			attr_dev(div8, "class", "notes");
    			add_location(div8, file$1d, 102, 0, 2224);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1j($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<NotSpreadsheet> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("NotSpreadsheet", $$slots, []);
    	$$self.$capture_state = () => ({ rows, cols, content, letters });
    ...
    class NotSpreadsheet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/03.word-wrap/SplayTree.svelte generated by Svelte v3.24.1 */

    const file$1e = "src/03.word-wrap/SplayTree.svelte";
    ...
    function create_fragment$1k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			span1 = element("span");
    			span1.textContent = "splay tree?";
    			t5 = space();
    			div1 = element("div");
    			t6 = space();
    			div5 = element("div");
    			li = element("li");
    			li.textContent = "need a phd to create a text-based application";
    			attr_dev(div0, "class", "f2 i");
    			add_location(div0, file$1e, 18, 4, 207);
    			attr_dev(span0, "class", "blue med  svelte-oyafco");
    			add_location(span0, file$1e, 20, 6, 267);
    			attr_dev(span1, "class", "red i");
    			add_location(span1, file$1e, 21, 6, 306);
    			attr_dev(div1, "class", "blue med  svelte-oyafco");
    			add_location(div1, file$1e, 22, 6, 351);
    			attr_dev(div2, "class", "med svelte-oyafco");
    			add_location(div2, file$1e, 19, 4, 243);
    			add_location(div3, file$1e, 17, 2, 197);
    			attr_dev(div4, "class", "box big svelte-oyafco");
    			add_location(div4, file$1e, 16, 0, 173);
    			add_location(li, file$1e, 27, 2, 426);
    			attr_dev(div5, "class", "notes");
    			add_location(div5, file$1e, 26, 0, 404);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1k($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SplayTree> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SplayTree", $$slots, []);
    	return [];
    }

    class SplayTree extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/03.word-wrap/Crdt.svelte generated by Svelte v3.24.1 */
    const file$1f = "src/03.word-wrap/Crdt.svelte";
    ...
    function create_fragment$1l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1f, 14, 0, 251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1l($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Crdt> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Crdt", $$slots, []);
    	$$self.$capture_state = () => ({ Image, wait, images });
    ...
    class Crdt extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/03.word-wrap/XiEditor.svelte generated by Svelte v3.24.1 */
    const file$1g = "src/03.word-wrap/XiEditor.svelte";
    ...
    function create_fragment$1m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1g, 13, 0, 208);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1m($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<XiEditor> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("XiEditor", $$slots, []);
    	$$self.$capture_state = () => ({ Image, images });
    ...
    class XiEditor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    class _03_word_wrap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1n, create_fragment$1n, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    const file$1h = "src/04.text-editor/Drake.svelte";
    ...
    function create_fragment$1o(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1h, 12, 0, 197);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1i = "src/04.text-editor/Timeline.svelte";
    ...
    function create_fragment$1p(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$1i, 25, 4, 389);
    			attr_dev(div0, "class", "middle svelte-1cxyf7j");
    			add_location(div0, file$1i, 24, 2, 364);
    			attr_dev(div1, "class", "box ");
    			add_location(div1, file$1i, 23, 0, 343);
    			attr_dev(div2, "class", "notes");
    			add_location(div2, file$1i, 33, 0, 511);
    			add_location(li, file$1i, 34, 0, 533);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/04.text-editor/Menu.svelte generated by Svelte v3.24.1 */
    const file$1j = "src/04.text-editor/Menu.svelte";
    ...
    function create_fragment$1q(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div9 = element("div");
    			li0 = element("li");
    			li0.textContent = "1 - anaphora resolution";
    			t14 = space();
    			li1 = element("li");
    			li1.textContent = "2 -setting tone";
    			t16 = space();
    			li2 = element("li");
    			li2.textContent = "3 - verb-agreement";
    			t18 = space();
    			li3 = element("li");
    			li3.textContent = "4 - adverb-ordering";
    			if (img.src !== (img_src_value = "./src/04.text-editor/assets/parking.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$1j, 30, 6, 533);
    			set_style(div0, "width", "350px");
    			add_location(div0, file$1j, 29, 4, 500);
    			attr_dev(span0, "class", "num red svelte-1spno7j");
    			add_location(span0, file$1j, 35, 10, 699);
    			attr_dev(div1, "class", "f2 svelte-1spno7j");
    			add_location(div1, file$1j, 34, 8, 672);
    			attr_dev(span1, "class", "num pink svelte-1spno7j");
    			add_location(span1, file$1j, 39, 10, 812);
    			attr_dev(div2, "class", "f2 svelte-1spno7j");
    			add_location(div2, file$1j, 38, 8, 785);
    			attr_dev(span2, "class", "num rose svelte-1spno7j");
    			add_location(span2, file$1j, 43, 10, 921);
    			attr_dev(div3, "class", "f2 svelte-1spno7j");
    			add_location(div3, file$1j, 42, 8, 894);
    			attr_dev(span3, "class", "num svelte-1spno7j");
    			add_location(span3, file$1j, 47, 10, 1036);
    			attr_dev(div4, "class", "f2 rouge svelte-1spno7j");
    			add_location(div4, file$1j, 46, 8, 1003);
    			set_style(div5, "text-align", "left");
    			attr_dev(div5, "class", "ml3");
    			add_location(div5, file$1j, 33, 6, 621);
    			add_location(div6, file$1j, 32, 4, 609);
    			attr_dev(div7, "class", "row svelte-1spno7j");
    			add_location(div7, file$1j, 28, 2, 478);
    			attr_dev(div8, "class", "box");
    			add_location(div8, file$1j, 27, 0, 458);
    			add_location(li0, file$1j, 55, 2, 1167);
    			add_location(li1, file$1j, 56, 2, 1202);
    			add_location(li2, file$1j, 57, 2, 1229);
    			add_location(li3, file$1j, 58, 2, 1259);
    			attr_dev(div9, "class", "notes");
    			add_location(div9, file$1j, 54, 0, 1145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/04.text-editor/Anaphor.svelte generated by Svelte v3.24.1 */
    const file$1k = "src/04.text-editor/Anaphor.svelte";
    ...
    function create_fragment$1r(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "anaphor resolution demo";
    			t1 = space();
    			video = element("video");
    			track = element("track");
    			attr_dev(div0, "class", "goleft i svelte-168a1sb");
    			add_location(div0, file$1k, 15, 2, 290);
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1k, 17, 4, 396);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1k, 16, 2, 344);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1k, 14, 0, 270);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1r($$self, $$props, $$invalidate) {
    	let src = "./src/04.text-editor/assets/anaphor.mp4";
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Anaphor> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Anaphor", $$slots, []);
    	$$self.$capture_state = () => ({ Video, wait, src });
    ...
    class Anaphor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/04.text-editor/Dates.svelte generated by Svelte v3.24.1 */
    const file$1l = "src/04.text-editor/Dates.svelte";
    ...
    function create_fragment$1s(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "date-parsing demo";
    			t1 = space();
    			video = element("video");
    			track = element("track");
    			attr_dev(div0, "class", "goleft i svelte-168a1sb");
    			add_location(div0, file$1l, 15, 2, 288);
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1l, 17, 4, 388);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1l, 16, 2, 336);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1l, 14, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1s($$self, $$props, $$invalidate) {
    	let src = "./src/04.text-editor/assets/dates.mp4";
    	const writable_props = [];
    ...
    /* src/04.text-editor/Modal.svelte generated by Svelte v3.24.1 */
    const file$1m = "src/04.text-editor/Modal.svelte";
    ...
    function create_fragment$1t(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "verb-agreement demo";
    			t1 = space();
    			video = element("video");
    			track = element("track");
    			attr_dev(div0, "class", "goleft i svelte-168a1sb");
    			add_location(div0, file$1m, 15, 2, 320);
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1m, 17, 4, 422);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1m, 16, 2, 370);
    			attr_dev(div1, "class", "box");
    			set_style(div1, "justify-content", "start");
    			add_location(div1, file$1m, 14, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1t($$self, $$props, $$invalidate) {
    	let src = "./src/04.text-editor/assets/modal.mp4";
    	const writable_props = [];
    ...
    /* src/04.text-editor/Numbers.svelte generated by Svelte v3.24.1 */
    const file$1n = "src/04.text-editor/Numbers.svelte";
    ...
    function create_fragment$1u(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "number-parsing demo";
    			t1 = space();
    			video = element("video");
    			track = element("track");
    			attr_dev(div0, "class", "goleft i svelte-168a1sb");
    			add_location(div0, file$1n, 15, 2, 290);
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1n, 17, 4, 392);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1n, 16, 2, 340);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1n, 14, 0, 270);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1u($$self, $$props, $$invalidate) {
    	let src = "./src/04.text-editor/assets/numbers.mp4";
    	const writable_props = [];
    ...
    /* src/04.text-editor/Sentences.svelte generated by Svelte v3.24.1 */
    const file$1o = "src/04.text-editor/Sentences.svelte";
    ...
    function create_fragment$1v(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "sentence-re-order demo";
    			t1 = space();
    			video = element("video");
    			track = element("track");
    			attr_dev(div0, "class", "goleft i svelte-168a1sb");
    			add_location(div0, file$1o, 15, 2, 297);
    			attr_dev(track, "kind", "captions");
    			add_location(track, file$1o, 17, 4, 402);
    			if (video.src !== (video_src_value = /*src*/ ctx[0])) attr_dev(video, "src", video_src_value);
    			video.loop = "true";
    			video.autoplay = true;
    			video.muted = video_muted_value = true;
    			add_location(video, file$1o, 16, 2, 350);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1o, 14, 0, 277);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1v($$self, $$props, $$invalidate) {
    	let src = "./src/04.text-editor/assets/sentence-order.mp4";
    	const writable_props = [];
    ...
    function instance$1w($$self, $$props, $$invalidate) {
    	...
    	let { doEnd = false } = $$props;
    	let steps = [Drake, Timeline$1, Menu$1, Anaphor, Sentences, Numbers, Dates, Modal];
    	let i = 0;
    ...
    class _04_text_editor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1w, create_fragment$1w, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    /* src/05.focus/Focus.svelte generated by Svelte v3.24.1 */
    const file$1p = "src/05.focus/Focus.svelte";
    ...
    function create_fragment$1x(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "keyboard focus:";
    			t1 = space();
    			create_component(video_1.$$.fragment);
    			set_style(div0, "align-self", "flex-start");
    			add_location(div0, file$1p, 13, 2, 211);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1p, 12, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1x($$self, $$props, $$invalidate) {
    	let video = { src: "./src/05.focus/assets/focus.mp4" };
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Focus> was created with unknown prop '${key}'`);
    	});
    ...
    /* src/05.focus/Browser.svelte generated by Svelte v3.24.1 */

    const file$1q = "src/05.focus/Browser.svelte";
    ...
    function create_fragment$1y(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div8 = element("div");
    			li = element("li");
    			li.textContent = "ambiguous";
    			attr_dev(input0, "class", "address svelte-1m52ikz");
    			input0.value = "coolwebsite.com";
    			add_location(input0, file$1q, 69, 6, 1300);
    			attr_dev(div0, "class", "word i svelte-1m52ikz");
    			add_location(div0, file$1q, 78, 10, 1593);
    			attr_dev(input1, "class", "text svelte-1m52ikz");
    			add_location(input1, file$1q, 79, 10, 1638);
    			attr_dev(div1, "class", "mid svelte-1m52ikz");
    			add_location(div1, file$1q, 77, 8, 1565);
    			attr_dev(div2, "class", "word i svelte-1m52ikz");
    			add_location(div2, file$1q, 82, 10, 1712);
    			attr_dev(input2, "class", "text svelte-1m52ikz");
    			add_location(input2, file$1q, 83, 10, 1757);
    			attr_dev(div3, "class", "mid svelte-1m52ikz");
    			add_location(div3, file$1q, 81, 8, 1684);
    			attr_dev(div4, "class", "border col svelte-1m52ikz");
    			add_location(div4, file$1q, 70, 6, 1356);
    			attr_dev(div5, "class", "window svelte-1m52ikz");
    			add_location(div5, file$1q, 68, 4, 1273);
    			attr_dev(div6, "class", "screen row svelte-1m52ikz");
    			add_location(div6, file$1q, 67, 2, 1244);
    			attr_dev(div7, "class", "box");
    			add_location(div7, file$1q, 66, 0, 1224);
    			add_location(li, file$1q, 90, 2, 1857);
    			attr_dev(div8, "class", "notes");
    			add_location(div8, file$1q, 89, 0, 1835);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1y($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Browser> was created with unknown prop '${key}'`);
    	});
    ...
    const file$1r = "src/05.focus/Zelda.svelte";
    ...
    function create_fragment$1z(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(video_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1r, 12, 0, 193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1s = "src/05.focus/Canon-cat.svelte";
    ...
    function create_fragment$1A(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1s, 9, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1t = "src/05.focus/Spicer.svelte";
    ...
    function create_fragment$1B(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1t, 7, 0, 133);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1u = "src/05.focus/Quake.svelte";
    ...
    function create_fragment$1C(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(image_1.$$.fragment);
    			attr_dev(div, "class", "box");
    			add_location(div, file$1u, 9, 0, 188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/05.focus/Conclusion.svelte generated by Svelte v3.24.1 */

    const file$1v = "src/05.focus/Conclusion.svelte";
    ...
    function create_fragment$1D(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "./src/01.02.typing/assets/engelbart/engelbart-3.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$1v, 48, 8, 948);
    			attr_dev(div0, "class", "square svelte-1lg84dv");
    			add_location(div0, file$1v, 47, 6, 919);
    			attr_dev(div1, "class", "arrow svelte-1lg84dv");
    			add_location(div1, file$1v, 53, 6, 1091);
    			set_style(img1, "height", "220px");
    			set_style(img1, "box-shadow", "none");
    			if (img1.src !== (img1_src_value = "./src/05.focus/assets/keyboard.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$1v, 55, 8, 1153);
    			attr_dev(div2, "class", "square svelte-1lg84dv");
    			add_location(div2, file$1v, 54, 6, 1124);
    			attr_dev(div3, "class", "row svelte-1lg84dv");
    			add_location(div3, file$1v, 46, 4, 895);
    			set_style(img2, "width", "300px");
    			set_style(img2, "margin-top", "4rem");
    			set_style(img2, "box-shadow", "none");
    			if (img2.src !== (img2_src_value = "./src/05.focus/assets/loop.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$1v, 64, 8, 1361);
    			attr_dev(div4, "class", "square svelte-1lg84dv");
    			add_location(div4, file$1v, 63, 6, 1332);
    			attr_dev(div5, "class", "arrow svelte-1lg84dv");
    			add_location(div5, file$1v, 69, 6, 1518);
    			set_style(img3, "width", "450px");
    			set_style(img3, "box-shadow", "none");
    			if (img3.src !== (img3_src_value = "./src/05.focus/assets/cursor.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			add_location(img3, file$1v, 71, 8, 1580);
    			attr_dev(div6, "class", "square svelte-1lg84dv");
    			add_location(div6, file$1v, 70, 6, 1551);
    			attr_dev(div7, "class", "row svelte-1lg84dv");
    			add_location(div7, file$1v, 62, 4, 1308);
    			attr_dev(div8, "class", "container svelte-1lg84dv");
    			add_location(div8, file$1v, 45, 2, 867);
    			attr_dev(div9, "class", "box");
    			add_location(div9, file$1v, 44, 0, 847);
    			attr_dev(div10, "class", "notes");
    			add_location(div10, file$1v, 79, 0, 1743);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1D($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Conclusion> was created with unknown prop '${key}'`);
    	});
    ...
    class Conclusion extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1D, create_fragment$1D, safe_not_equal, { done: 0, doEnd: 1, prev: 2 });
    		...
    		if (/*doEnd*/ ctx[1] === undefined && !("doEnd" in props)) {
    			console.warn("<Conclusion> was created without expected prop 'doEnd'");
    		}

    		if (/*prev*/ ctx[2] === undefined && !("prev" in props)) {
    			console.warn("<Conclusion> was created without expected prop 'prev'");
    		}
    	}

    	get done() {
    		throw new Error("<Conclusion>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set done(value) {
    		throw new Error("<Conclusion>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function instance$1E($$self, $$props, $$invalidate) {
    	...
    	let { doEnd = false } = $$props;
    	let steps = [Focus, Spicer, Zelda, Browser, Canon_cat, Quake, Conclusion];
    	let i = 0;
    ...
    class _05_focus extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1E, create_fragment$1E, safe_not_equal, { done: 4, prev: 5, doEnd: 6 });
    ...
    function create_fragment$1F(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			div1 = element("div");
    			t1 = text("@spencermountain\n      ");
    			div0 = element("div");
    			div0.textContent = "spencermounta.in/nlp-oss-2020";
    			t3 = space();
    			div4 = element("div");
    			set_style(img, "width", "250px");
    			if (img.src !== (img_src_value = "./src/00.intro/assets/cn-tower.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$1w, 23, 4, 398);
    			attr_dev(div0, "class", "small svelte-1hwnnc4");
    			add_location(div0, file$1w, 26, 6, 514);
    			add_location(div1, file$1w, 24, 4, 479);
    			attr_dev(div2, "class", "row svelte-1hwnnc4");
    			add_location(div2, file$1w, 22, 2, 376);
    			attr_dev(div3, "class", "box");
    			add_location(div3, file$1w, 21, 0, 356);
    			attr_dev(div4, "class", "notes");
    			add_location(div4, file$1w, 30, 0, 596);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1G(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*doEnd*/ 1) switch_instance_changes.doEnd = /*doEnd*/ ctx[0];

    			if (switch_value !== (switch_value = /*step*/ ctx[1])) {
    				if (switch_instance) {
    					group_outros();
    					const old_component = switch_instance;
    ...
    function instance$1G($$self, $$props, $$invalidate) {
    	...
    	function prev() {
    		...
    		$$invalidate(4, i = i < 0 ? 0 : i); // dont go under 0
    		$$invalidate(0, doEnd = true);
    	}
    	...
    	function done() {
    		...
    		$$invalidate(0, doEnd = false);
    	}

    	function changeIt(e) {
    		$$invalidate(4, i = parseInt(e.target.value, 10));
    	...
    	$$self.$capture_state = () => ({
    		...
    		Start,
    		Intro: _00_intro,
    		Keyboards: _01_00_keyboards,
    		Typing: _01_02_typing,
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("doEnd" in $$props) $$invalidate(0, doEnd = $$props.doEnd);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*i*/ 16) {
    			 $$invalidate(1, step = steps[i]);
    		}
    	};

    	return [doEnd, step, prev, done];
    }
