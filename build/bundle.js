...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 45, 4, 812);
    			attr_dev(div1, "class", "sub svelte-gke2c");
    			add_location(div1, file, 46, 4, 849);
    			attr_dev(div2, "class", "caption svelte-gke2c");
    			add_location(div2, file, 44, 2, 786);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(track, file, 51, 4, 971);
    			...
    			add_location(video, file, 50, 2, 912);
    			attr_dev(div, "class", "m3");
    			add_location(div, file, 49, 0, 893);
    		},
    ...
    const file$1 = "src/05.focus/Focus.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 13, 2, 211);
    			attr_dev(div1, "class", "box");
    			add_location(div1, file$1, 12, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
